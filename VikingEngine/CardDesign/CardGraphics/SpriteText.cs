...
namespace VikingEngine.CardDesign.CardGraphics
{
    class SpriteText : VikingEngine.Graphics.AbsSpriteText
    {
        ...
        public SpriteText(string textString, Vector2 position, float height, ImageLayers layer, Vector2 relCenter, Color color)
            : base(LetterWidthScale,
            textString, position, height, layer, relCenter, color, false)
        { }
