...
namespace VikingEngine.DSSWars.Build
{
    ...
    static class BuildLib
    {
        ...
        public static void Init()
        {
            ...
            new BuildOption(BuildAndExpandType.ResearchCenter, TerrainMainType.Building, (int)TerrainBuildingType.ResearchCenter, SpriteName.MissingImage, CraftBuildingLib.ResearchCenter, false, BuildCategoryTab.Upgrade, MapPaintToolCategory.Default, DssConst.WorkTime_Building_Large);
            new BuildOption(BuildAndExpandType.BookPress, TerrainMainType.Building, (int)TerrainBuildingType.BookPress, SpriteName.MissingImage, CraftBuildingLib.BookPress, false, BuildCategoryTab.Upgrade, MapPaintToolCategory.Default, DssConst.WorkTime_Building_Default);
