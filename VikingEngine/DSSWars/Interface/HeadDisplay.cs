...
//using System.Linq;
//using System.Text;
//using VikingEngine.DSSWars.Translation;
...
//                        {
//                            var text = new RbText(LangLib.Tab(tabOptions[i], out string description));
...
//                            if (tabOptions[i] == player.factionTab)
//                            {
//                                tabSel = i;
//                            }
//                        }
...
//                                faction.resourceTab(player, content);
//                                break;
...
//                        //content.ButtonDescription(player.gameControls.input.NextBattle, DssRef.lang.InputActionName_NextBattle);
...
//                content.icontext(SpriteName.rtsUpkeepTime, string.Format(DssRef.lang.Economy_ServicemenUpkeep, Resource.Money.CopperToGoldString_Decimal(faction.citiesEconomy.servicemenUpkeep_copp)));
//                content.space();
