    ...
    class PlayerHud_Faction: IPlayerHud_Menu
    {
        ...
        void economyTab(LocalPlayer player)
        {
            ...
            
            {
                ...
                content.space();
                var textCont = new RbText(string.Format(DssRef.todoLang.Language_LabelAndText_Colon, DssRef.lang.Economy_TaxIncome, Money.CopperToGoldString_Large(player.faction.citiesEconomy.taxIncome_copp)),
