...
//    {
//        protected Graphics.Mesh mapPlane;
...
//            mapPlane = new Graphics.Mesh(LoadedMesh.plane, VectorExt.SetY(Vector3.Zero, DssLib.OverviewMapYpos), Vector3.One,
//                TextureEffectType.Flat, SpriteName.NO_IMAGE, Color.White, false);
            
//            mapPlane.TextureSource = source;
...
//            mapPlane.position = vol.Position;
//            mapPlane.scale = vol.Scale;
