...
namespace VikingEngine.LF2.GameObjects.Characters
{
    class EndMagician : AbsEnemy
    {
        ...
        {
            CollisionBound = LF2.ObjSingleBound.QuickBoundingBox(Scale * 0.22f);
            image = LF2.Data.ImageAutoLoad.AutoLoadImgInstace(VoxelModelName.end_magician, TempCharacterImage, Scale, 1,
