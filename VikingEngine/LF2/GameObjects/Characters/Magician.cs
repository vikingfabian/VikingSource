...
#region BATTLEAREA
            ...
            for (int i = 0; i < LfRef.LocalHeroes.Count; i++)
            {
                ...
                {//make sure he wont leave
                    if (h.Alive)
                    {
                        ...
                        {
                            h.TakeDamage(new WeaponAttack.DamageData(10, WeaponAttack.WeaponUserType.Neutral, ByteVector2.Zero, Gadgets.GoodsType.NONE, Magic.MagicElement.Evil), true);
        ...
        void magicianInit()
        {
            ...
            CollisionBound = LF2.ObjSingleBound.QuickBoundingBox(new Vector3(boundW, boundW * 2f, boundW), 1.5f);
            image = LF2.Data.ImageAutoLoad.AutoLoadImgInstace(VoxelModelName.magician, TempCharacterImage, scale, 1, 
            ...
            Data.ImageAutoLoad.PreLoadImage(VoxelModelName.magician_sword, false, 0);
        ...
        void setState(AiState state, ISpottedArrayCounter<GameObjects.AbsUpdateObj> active)
        {
            this.state = state;
            switch (state)
            {
        ...
        void createSword()
        {
            new WeaponAttack.HandWeaponAttack(stateRefreshTime, this,
                LF2.Data.ImageAutoLoad.AutoLoadImgInstace(VoxelModelName.magician_sword, TempSwordImage, swordScale, 0), swordScale,
        ...
        public override CharacterUtype CharacterType
        {
            get
            {
                return CharacterUtype.Magician;
            }
        }
