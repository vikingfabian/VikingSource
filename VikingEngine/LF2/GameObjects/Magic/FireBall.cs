...
namespace VikingEngine.LF2.GameObjects.Magic
{
    class MagicianFireBall : FireBall
    {
        ...
        {
            get { return (int)WeaponAttack.WeaponUtype.MagicianFireball; }
        }
    ...
    class FireBall : WeaponAttack.Linear3DProjectile//Weapons.AbsProjectile
    {
        ...
        static readonly LF2.ObjSingleBound Bound = new LF2.ObjSingleBound(
        ...
        public FireBall(GameObjects.WeaponAttack.DamageData damage, Vector3 startPosition, Rotation1D dir)
        ...
        public override void Time_Update(UpdateArgs args)
        {
            ...
            {
                particles[i] = new ParticleInitData(lib.RandomV3(image.position, 0.3f));
            }
        ...
        protected override bool handleCharacterColl(AbsUpdateObj character, LF2.ObjBoundCollData collisionData)
        {
            for (int i = 0; i < 8; i++)
            {
                Engine.ParticleHandler.AddParticles(Graphics.ParticleSystemType.Smoke,
                       new Graphics.ParticleInitData(lib.RandomV3(image.position, 1), Vector3.Zero));
            }
        ...
        {
            get { return VoxelModelName.FireBall; }
        }
