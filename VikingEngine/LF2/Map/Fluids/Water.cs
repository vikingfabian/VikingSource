...
namespace VikingEngine.LF2.Map.Fluids
{
    class Water
    {
        public Water(WorldPosition wp)
        {
            ...
            Graphics.ImageFile2 imgfileTop =  LF2.LootfestLib.Images.TileIxToImgeFile[VikingEngine.DataLib.Images.imagesNames[SpriteName.TextureWaterMap]];
