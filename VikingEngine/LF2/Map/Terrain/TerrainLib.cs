...
namespace VikingEngine.LF2.Map.Terrain
{
    static class TerrainLib
    {
        ...
        public static void Init()
        {
            ...
            //{
            //    Editor.VoxelObjDataLoader.VoxelObjListData(VoxelModelName.LabrinthWall1),
            //    Editor.VoxelObjDataLoader.VoxelObjListData(VoxelModelName.LabrinthWall2),
            //    Editor.VoxelObjDataLoader.VoxelObjListData(VoxelModelName.LabrinthWall3),
            //    Editor.VoxelObjDataLoader.VoxelObjListData(VoxelModelName.LabrinthWall4)
            //};
        ...
        {
            return areaHills[(int)env][Data.RandomSeed.Instance.Next(NumHillsPerAreaType)];
        }
    }
    struct AreaInfo
    {
