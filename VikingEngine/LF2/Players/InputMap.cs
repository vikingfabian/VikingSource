...
namespace VikingEngine.LF2.Players
{
    class InputMap : PlayerInputMap
    {
        ...
        override public void keyboardSetup()
        {
            ...
            viewMap = new KeyboardButtonMap(Keys.M);

            viewHelp = new KeyboardButtonMap(Keys.Back);
        ...
        override public void xboxSetup()
        {
            ...
            viewMap = new XboxButtonMap(Buttons.DPadDown, inputSource.controllerIndex);

            viewHelp = new XboxButtonMap(Buttons.Back, inputSource.controllerIndex);
