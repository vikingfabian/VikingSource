...
namespace VikingEngine.LootFest.Editor.Scene
{
    ...
    {
        public void OpenMenuFile(HUD.GuiLayout file) { throw new NotImplementedException(); }
        ...
        void loadUserFile(string file, HUD.GuiLayout menu)
        {
            load(file, true);
        }
        ...
        {
            //new DataLib.ByteStream(save, Folder + FilePath.Dir + currentFileName + FileEnd, this, DataLib.ThreadType.SaveAndLoad);
        ...
        public void CamerasToMenu(HUD.GuiLayout mFile)
        {
