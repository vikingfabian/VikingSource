...
{
    class BouncingBlock2Dummie : AbsInGameUpdateable
    {
            ...
            :base(false)
        {
            ...
            block = new Graphics.Mesh(LoadedMesh.cube_repeating, startPos, new Vector3(scale),
                TextureEffectType.Flat, Data.BlockTextures.MaterialTile(material), Color.White);
            block.Rotation = RotationQuarterion.Random;
            //Rotation1D dir = Rotation1D.Random();
            dir.Add(Ref.rnd.Plus_MinusF(0.4f));
            speed = VectorExt.V2toV3XZ(dir.Direction(EffectLib.StandardStartSideSpeed.GetRandom()));
    ...
    struct BouncingBlockColors
    {
        ...
        public BouncingBlockColors(Data.MaterialType m1)
        {
            M1 = m1;
            M2 = m1;
            M3 = m1;
        }
        public BouncingBlockColors(Data.MaterialType m1, Data.MaterialType m2)
        {
            M1 = m1;
            M2 = m2;
            M3 = m1;
