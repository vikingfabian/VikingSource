...
namespace VikingEngine.LootFest
{
    ...
    abstract class AbsHUD : LazyUpdate
    {
        ...
        //public AbsHUD(VoxelObjName iconName)
        //    :base(false)
        //{
        //    icon = LootfestLib.Images.GetVoxelIcon(iconName, Vector2.Zero, VectorExt.V2(HUDStandardHeight), HUDLayer);
        //}
        public AbsHUD(SpriteName iconTile)
            : base(false)
        {
            icon = new Image(iconTile, Vector2.Zero, VectorExt.V2(HUDStandardHeight), HUDLayer, false);
