...
//            new Vector2(1f / Map.WorldPosition.WorldChunkSize, 1f / Map.WorldPosition.WorldChunkSize);
...
//            new IntVector2(Map.WorldPosition.WorldChunkSize / ChunksDivide, Map.WorldPosition.WorldChunkSize / ChunksDivide);

//        public const ImageLayers MapBackgroundLayer = ImageLayers.Lay6;

//        public MiniMap(VectorRect screenArea, MiniMapSettings settings, GO.PlayerCharacter.AbsHero hero,
//            bool travel, Graphics.AbsCamera camera,  
//            bool viewNewLocationIcon, IntVector2 newLocationIconPos)
//            :base(true)
//        {
//           this.screenArea = screenArea;
//            MapIcon.IconSize = new Vector2(lib.SmallestValue(Engine.Screen.Width, Engine.Screen.Height) * 0.06f);
...
//            locationNameBackg.Opacity = 0.5f;
...
//                        Color col = Color.White;//environmentColor[(int)LfRef.worldOverView.GetChunkData(chunkPos).Environment];
...
//            pointer = new Image(SpriteName.LFMenuPointer, center, VectorExt.V2(32), ImageLayers.AbsoluteTopLayer);
//            //pointer.Ypos += 16;
...
//            //    if (p != hero.Player)
//            //    {
//            //        icons.Add(new GamerMapIcon(p, p.AbsHero == hero));
//            //    }
//            //}
...
//        {
//            return new IntVector2(settings.Position * new Vector2(Map.WorldPosition.WorldChunkSize, Map.WorldPosition.WorldChunkSize));
//        }

//        public void Scroll(Vector2 dir)
//        {
//            float move = ScrollSpeed / settings.Scale;
//            settings.Position.X = Bound.SetBounds(settings.Position.X + dir.X * move, 0, 1);
//            settings.Position.Y = Bound.SetBounds(settings.Position.Y + dir.Y * move, 0, 1);
...
//    class MapIcon
//    {
//        public static Vector2 IconSize;// = VectorExt.V2(32);
//        Vector2 relPos;
...
//    //    {
//    //        chunkPos = player.AbsHero.WorldPosition.ChunkPosFloating;
//    //        icon.Rotation = player.AbsHero.Rotation.Radians;
            
//    //        updateRelPos();
//    //        base.Update(settings, safeAre, backgroundPos);
//    //        icon.Visible = icon.Visible && player.AbsHero.Alive;
...
//            set
//            {
//                scale = Bound.SetBounds(value, 1, 20);
//            }
//        }
//        public Vector2 Size
//        {
//            get
//            {
//                return new Vector2(Scale * Map.WorldPosition.WorldChunkSize, Scale * Map.WorldPosition.WorldChunkSize);
//            }
//        }
//    }
//}
