...
//        static readonly Vector2 FontSize = VectorExt.V2(Scale);
...
//            title = new TextG(LoadedFont.Lootfest, titlePos + new Vector2(TitleEdge, 0), VectorExt.V2(1), Align.Zero, data.SpeakerName, Color.White, ImageLayers.Foreground2);
//            nameBakg = new Image(SpriteName.WhiteArea, titlePos, new Vector2(title.MeasureText().X + TitleEdge * PublicConstants.Twice, TitleBakgHeight), ImageLayers.Foreground3);
