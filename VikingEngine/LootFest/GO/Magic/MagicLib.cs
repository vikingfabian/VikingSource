...
namespace VikingEngine.LootFest.GO.Magic
{
    static class MagicLib
    {
        ...
        //    {
        //        int rndIx = Data.WorldSeed.Instance.Next(magicTypes.Count);

        //        GemToMagic.Add(GemTypes[i], magicTypes[rndIx]);
        //        magicTypes.Remove(magicTypes[rndIx]);
        //    }

        //    int storeSeedPos = Data.WorldSeed.Instance.GetSeedPosition; //To aviod disrupting the seed for old saves
        ...
        //             GO.Gadgets.GadgetLib.GadgetIcon(GO.Gadgets.GadgetLib.BluePrintToGoodstype(bp)),
        ...
        //                new List<Gadgets.GoodsType> { Data.WorldSeed.Instance.RandomListMemeberRemove(bombIngrediences) }, 1));
        //        }
        ...
        //        {
        //            gem = Data.WorldSeed.Instance.RandomListMemeber(GemTypes);
        //            numGems = 1;
        //        }
        //        else
        //        {
        ...
        //            {
        //                new Data.Gadgets.Ingredient("Metal", new List<Gadgets.GoodsType>{ Data.WorldSeed.Instance.RandomListMemeber(ringMetals) }, 1),
        //                new Data.Gadgets.Ingredient("Gem", new List<Gadgets.GoodsType>{ gem }, numGems),
        //            };
        //        if (magicRingSkillElement == MagicElement.NoMagic)
        //        {
        //            ingrediences.Add(new Data.Gadgets.Ingredient("Item", new List<Gadgets.GoodsType> { Data.WorldSeed.Instance.RandomListMemeberRemove(ringIngrediences) }, 2));
        //        }
        ...
        //            //Ingrediences
        //            new Data.Gadgets.BlueprintIngrediens(GO.Gadgets.Jevelery.MagicRingSkillIcon(skill), "Magic ring " + ((int)skill).ToString(),
        //                ingrediences)
        //            );
        //    }


        //    Data.WorldSeed.Instance.SetSeedPosition(storeSeedPos);
        //}
        ...
        //    {
        //        ingrediences.Requierd.Add(new Data.Gadgets.Ingredient("Ingredience " + TextLib.IndexToString(i),
        //            new List<Gadgets.GoodsType> { Data.WorldSeed.Instance.RandomListMemeberRemove(bombIngrediences) }, 2));
        //    }
