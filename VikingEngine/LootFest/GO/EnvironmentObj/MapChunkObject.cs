...
//{
//    abstract class MapChunkObject : LootFest.Director.IEnvObjGenerator
//    {
////#if DEBUGMODE
...
//            if (EarMark)
//            {
//                Debug.Log("Ear marked BeginGeneratorRequest:" + this.ToString());
//            }
////#endif
...
//            if (EarMark)
//            {
//                Debug.Log("Ear marked GenerateEnvironemtObjects:" + this.ToString() +
