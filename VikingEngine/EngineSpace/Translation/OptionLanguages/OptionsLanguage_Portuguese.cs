...
namespace VikingEngine.EngineSpace.Translation.OptionLanguages
{
    ...
    class OptionsLanguage_Portuguese : AbsOptionsLanguage
    {
        ...
        public override string GameSettings_UltraWide_LeftEdge => "Borda esquerda da UI";
        public override string GameSettings_UltraWide_RightEdge => "Borda direita da UI";
        //-------
