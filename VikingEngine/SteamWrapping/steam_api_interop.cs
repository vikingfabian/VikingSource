...
// This file is auto-generated, do not edit it. <- hehe, yeah if it actually WORKED I wouldn't have to.
//
//=============================================================================
...
namespace Valve.Steamworks
{
    ...
    //public delegate void SteamWarningMessageHookDelegate(int severity, sbyte[] message);
	...
	public abstract class ISteamUser
	{
		...
		public abstract EVoiceResult GetAvailableVoice(out uint pcbCompressed, out uint pcbUncompressed, uint nUncompressedVoiceDesiredSampleRate);
		public abstract EVoiceResult GetVoice(bool bWantCompressed, byte[] pDestBuffer, uint cbDestBufferSize, out uint nBytesWritten, bool bWantUncompressed, byte[] pUncompressedDestBuffer, uint cbUncompressedDestBufferSize, out uint nUncompressBytesWritten, uint nUncompressedVoiceDesiredSampleRate);
		public abstract EVoiceResult DecompressVoice(byte[] pCompressed, uint cbCompressed, byte[] pDestBuffer, uint cbDestBufferSize, out uint nBytesWritten, uint nDesiredSampleRate);
	...
	public abstract class ISteamFriends
	{
		...
		public abstract void GetFriendsGroupMembersList(char friendsGroupID,out ulong [] pOutSteamIDMembers);
		...
		public abstract int GetClanChatMessage(ulong steamIDClanChat,int iMessage,IntPtr prgchText,int cchTextMax,ref uint peChatEntryType,out ulong psteamidChatter);
	...
	public abstract class ISteamMatchmaking
	{
		...
		public abstract void AddRequestLobbyListStringFilter(string pchKeyToMatch,string pchValueToMatch, ELobbyComparison eComparisonType);
        ...
        /// <summary>
        /// Variabler som sättas och sedan användas att filtrera sökning
        /// </summary>
        ...
        public abstract int GetLobbyChatEntry(ulong steamIDLobby, int iChatID, out ulong pSteamIDUser, byte[] pvData, int cubData, out EChatEntryType peChatEntryType);
		...
		public abstract bool GetLobbyGameServer(ulong steamIDLobby,ref uint punGameServerIP,ref char punGameServerPort,out ulong psteamIDGameServer);
	...
	public abstract class ISteamRemoteStorage
	{
		...
		public abstract bool GetUGCDetails(ulong hContent,ref uint pnAppID,string ppchName,ref int pnFileSizeInBytes,out ulong pSteamIDOwner);
	...
	public abstract class ISteamUserStats
	{
		...
		public abstract bool GetStat_Int(string pchName,ref int pData);
		public abstract bool GetStat_Float(string pchName,ref float pData);
		public abstract bool SetStat_Int(string pchName,int nData);
		public abstract bool SetStat_Float(string pchName,float fData);
		...
		public abstract bool GetUserStat_Int(ulong steamIDUser,string pchName,ref int pData);
		public abstract bool GetUserStat_Float(ulong steamIDUser,string pchName,ref float pData);
		...
		public abstract string GetLeaderboardName(SteamLeaderboard_t hSteamLeaderboard);
		public abstract int GetLeaderboardEntryCount(SteamLeaderboard_t hSteamLeaderboard);
		public abstract uint GetLeaderboardSortMethod(SteamLeaderboard_t hSteamLeaderboard);
		public abstract uint GetLeaderboardDisplayType(SteamLeaderboard_t hSteamLeaderboard);
		public abstract ulong DownloadLeaderboardEntries(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest,int nRangeStart,int nRangeEnd);
		public abstract ulong DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard,ulong [] prgUsers);
		public abstract bool GetDownloadedLeaderboardEntry(ulong hSteamLeaderboardEntries,int index,ref LeaderboardEntry_t pLeaderboardEntry, int[] pDetails,int cDetailsMax);
		public abstract ulong UploadLeaderboardScore(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, int nScore, int[] pScoreDetails, int cScoreDetailsCount);
		public abstract ulong AttachLeaderboardUGC(SteamLeaderboard_t hSteamLeaderboard,ulong hUGC);
		...
		public abstract bool GetGlobalStat(string pchStatName,out long pData);
	...
	{
		public abstract IntPtr GetIntPtr();
		public abstract bool SendP2PPacket(ulong steamIDRemote, byte[] pubData, uint cubData, EP2PSend eP2PSendType, int nChannel);
		public abstract bool IsP2PPacketAvailable(out uint pcubMsgSize, int nChannel);
		public abstract bool ReadP2PPacket(byte[] pubDest, uint cubDest, out uint pcubMsgSize, out ulong psteamIDRemote, int nChannel);
		...
		public abstract bool GetSocketInfo(uint hSocket,ref ulong pSteamIDRemote,ref int peSocketStatus,ref uint punIPRemote,ref char punPortRemote);
	...
	public abstract class ISteamController
	{
		...
		public abstract int GetDigitalActionOrigins(ulong controllerHandle,ulong actionSetHandle,ulong digitalActionHandle, EControllerActionOrigin[] originsOut);
        ...
        public abstract int GetAnalogActionOrigins(ulong controllerHandle, ulong actionSetHandle, ulong analogActionHandle, EControllerActionOrigin[] originsOut);
		public abstract void StopAnalogActionMomentum(ulong controllerHandle,ulong eAction);
		public abstract void TriggerHapticPulse(ulong controllerHandle, ESteamControllerPad eTargetPad, ushort usDurationMicroSec);
	}
	...
	public abstract class ISteamGameServer
	{
		...
		public abstract bool SendUserConnectAndAuthenticate(uint unIPClient,IntPtr pvAuthBlob,uint cubAuthBlobSize,ref ulong pSteamIDUser);
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamClient_CreateSteamPipe(m_pSteamClient);
    return result;
}
public override bool BReleaseSteamPipe(uint hSteamPipe)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamClient_BReleaseSteamPipe(m_pSteamClient,hSteamPipe);
    return result;
}
public override uint ConnectToGlobalUser(uint hSteamPipe)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamClient_ConnectToGlobalUser(m_pSteamClient,hSteamPipe);
    return result;
}
public override uint CreateLocalUser(ref uint phSteamPipe,uint eAccountType)
{
    CheckIfUsable();
    phSteamPipe = 0;
    uint result = NativeCalls.SteamAPI_ISteamClient_CreateLocalUser(m_pSteamClient,ref phSteamPipe,eAccountType);
    return result;
}
public override void ReleaseUser(uint hSteamPipe,uint hUser)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_ReleaseUser(m_pSteamClient,hSteamPipe,hUser);
}
public override ISteamUser GetISteamUser(uint hSteamUser,uint hSteamPipe,string pchVersion)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamUser(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamGameServer(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_SetLocalIPBinding(m_pSteamClient,unIP,usPort);
}
public override ISteamFriends GetISteamFriends(uint hSteamUser,uint hSteamPipe,string pchVersion)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamFriends(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamUtils(m_pSteamClient,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamMatchmaking(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamMatchmakingServers(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamGenericInterface(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamUserStats(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamGameServerStats(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamApps(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamNetworking(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamRemoteStorage(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamScreenshots(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
    return (ISteamScreenshots) Marshal.PtrToStructure(result, typeof(ISteamScreenshots));
}
public override void RunFrame()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_RunFrame(m_pSteamClient);
}
public override uint GetIPCCallCount()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamClient_GetIPCCallCount(m_pSteamClient);
    return result;
}
public override void SetWarningMessageHook(SteamWarningMessageHookDelegate pFunction)
{
    CheckIfUsable();
    IntPtr f = Marshal.GetFunctionPointerForDelegate(pFunction);
    NativeCalls.SteamAPI_ISteamClient_SetWarningMessageHook(m_pSteamClient, f);
}
public override bool BShutdownIfAllPipesClosed()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamClient_BShutdownIfAllPipesClosed(m_pSteamClient);
    return result;
}
public override ISteamHTTP GetISteamHTTP(uint hSteamuser,uint hSteamPipe,string pchVersion)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamHTTP(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamUnifiedMessages(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamController(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamUGC(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamAppList(m_pSteamClient,hSteamUser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamMusic(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamMusicRemote(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamHTMLSurface(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_Set_SteamAPI_CPostAPIResultInProcess(m_pSteamClient,func);
}
public override void Remove_SteamAPI_CPostAPIResultInProcess(IntPtr func)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_Remove_SteamAPI_CPostAPIResultInProcess(m_pSteamClient,func);
}
public override void Set_SteamAPI_CCheckCallbackRegisteredInProcess(IntPtr func)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamClient_Set_SteamAPI_CCheckCallbackRegisteredInProcess(m_pSteamClient,func);
}
public override ISteamInventory GetISteamInventory(uint hSteamuser,uint hSteamPipe,string pchVersion)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamInventory(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamClient_GetISteamVideo(m_pSteamClient,hSteamuser,hSteamPipe,pchVersion);
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUser_GetHSteamUser(m_pSteamUser);
    return result;
}
...
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUser_InitiateGameConnection(m_pSteamUser,pAuthBlob,cbMaxAuthBlob,steamIDGameServer,unIPServer,usPortServer,bSecure);
    return result;
}
public override void TerminateGameConnection(uint unIPServer,char usPortServer)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_TerminateGameConnection(m_pSteamUser,unIPServer,usPortServer);
}
public override void TrackAppUsageEvent(ulong gameID,int eAppUsageEvent,string pchExtraInfo)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_TrackAppUsageEvent(m_pSteamUser,gameID,eAppUsageEvent,pchExtraInfo);
}
public override bool GetUserDataFolder(string pchBuffer,int cubBuffer)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUser_GetUserDataFolder(m_pSteamUser,pchBuffer,cubBuffer);
    return result;
}
public override void StartVoiceRecording()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_StartVoiceRecording(m_pSteamUser);
}
public override void StopVoiceRecording()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_StopVoiceRecording(m_pSteamUser);
}
public override EVoiceResult GetAvailableVoice(out uint pcbCompressed, out uint pcbUncompressed, uint nUncompressedVoiceDesiredSampleRate)
{
    CheckIfUsable();
    pcbCompressed = 0;
    pcbUncompressed = 0;
    EVoiceResult result = NativeCalls.SteamAPI_ISteamUser_GetAvailableVoice(m_pSteamUser, out pcbCompressed, out pcbUncompressed, nUncompressedVoiceDesiredSampleRate);
    return result;
}
public override EVoiceResult GetVoice(bool bWantCompressed, byte[] pDestBuffer, uint cbDestBufferSize, out uint nBytesWritten, bool bWantUncompressed, byte[] pUncompressedDestBuffer, uint cbUncompressedDestBufferSize, out uint nUncompressBytesWritten, uint nUncompressedVoiceDesiredSampleRate)
{
    CheckIfUsable();
    nBytesWritten = 0;
    nUncompressBytesWritten = 0;
    EVoiceResult result = NativeCalls.SteamAPI_ISteamUser_GetVoice(m_pSteamUser, bWantCompressed, pDestBuffer, cbDestBufferSize, out nBytesWritten, bWantUncompressed, pUncompressedDestBuffer, cbUncompressedDestBufferSize, out nUncompressBytesWritten, nUncompressedVoiceDesiredSampleRate);
    return result;
}
public override EVoiceResult DecompressVoice(byte[] pCompressed, uint cbCompressed, byte[] pDestBuffer, uint cbDestBufferSize, out uint nBytesWritten, uint nDesiredSampleRate)
{
    CheckIfUsable();
    nBytesWritten = 0;
    EVoiceResult result = NativeCalls.SteamAPI_ISteamUser_DecompressVoice(m_pSteamUser, pCompressed, cbCompressed, pDestBuffer, cbDestBufferSize, out nBytesWritten, nDesiredSampleRate);
    return result;
}
public override uint GetVoiceOptimalSampleRate()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUser_GetVoiceOptimalSampleRate(m_pSteamUser);
    return result;
}
public override uint GetAuthSessionTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
    CheckIfUsable();
    pcbTicket = 0;
    uint result = NativeCalls.SteamAPI_ISteamUser_GetAuthSessionTicket(m_pSteamUser,pTicket,cbMaxTicket,ref pcbTicket);
    return result;
}
public override uint BeginAuthSession(IntPtr pAuthTicket,int cbAuthTicket,ulong steamID)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUser_BeginAuthSession(m_pSteamUser,pAuthTicket,cbAuthTicket,steamID);
    return result;
}
public override void EndAuthSession(ulong steamID)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_EndAuthSession(m_pSteamUser,steamID);
}
public override void CancelAuthTicket(uint hAuthTicket)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_CancelAuthTicket(m_pSteamUser,hAuthTicket);
}
public override uint UserHasLicenseForApp(ulong steamID,uint appID)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUser_UserHasLicenseForApp(m_pSteamUser,steamID,appID);
    return result;
}
public override bool BIsBehindNAT()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUser_BIsBehindNAT(m_pSteamUser);
    return result;
}
public override void AdvertiseGame(ulong steamIDGameServer,uint unIPServer,char usPortServer)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUser_AdvertiseGame(m_pSteamUser,steamIDGameServer,unIPServer,usPortServer);
}
public override ulong RequestEncryptedAppTicket(IntPtr pDataToInclude,int cbDataToInclude)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUser_RequestEncryptedAppTicket(m_pSteamUser,pDataToInclude,cbDataToInclude);
    return result;
}
public override bool GetEncryptedAppTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
    CheckIfUsable();
    pcbTicket = 0;
    bool result = NativeCalls.SteamAPI_ISteamUser_GetEncryptedAppTicket(m_pSteamUser,pTicket,cbMaxTicket,ref pcbTicket);
    return result;
}
public override int GetGameBadgeLevel(int nSeries,bool bFoil)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUser_GetGameBadgeLevel(m_pSteamUser,nSeries,bFoil);
    return result;
}
public override int GetPlayerSteamLevel()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUser_GetPlayerSteamLevel(m_pSteamUser);
    return result;
}
public override ulong RequestStoreAuthURL(string pchRedirectURL)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUser_RequestStoreAuthURL(m_pSteamUser,pchRedirectURL);
    return result;
}
}
...
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetPersonaName(m_pSteamFriends);
    return InteropHelp.IntPtrToUTF8(result);
}
public override ulong SetPersonaName(string pchPersonaName)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_SetPersonaName(m_pSteamFriends,pchPersonaName);
    return result;
}
public override uint GetPersonaState()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamFriends_GetPersonaState(m_pSteamFriends);
    return result;
}
public override int GetFriendCount(int iFriendFlags)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendCount(m_pSteamFriends,iFriendFlags);
    return result;
}
public override ulong GetFriendByIndex(int iFriend,int iFriendFlags)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetFriendByIndex(m_pSteamFriends,iFriend,iFriendFlags);
    return result;
}
public override uint GetFriendRelationship(ulong steamIDFriend)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamFriends_GetFriendRelationship(m_pSteamFriends,steamIDFriend);
    return result;
}
public override uint GetFriendPersonaState(ulong steamIDFriend)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamFriends_GetFriendPersonaState(m_pSteamFriends,steamIDFriend);
    return result;
}
public override string GetFriendPersonaName(ulong steamIDFriend)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetFriendPersonaName(m_pSteamFriends, steamIDFriend);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool GetFriendGamePlayed(ulong steamIDFriend,out FriendGameInfo_t pFriendGameInfo)
{
    ...
    bool result = NativeCalls.SteamAPI_ISteamFriends_GetFriendGamePlayed(m_pSteamFriends,steamIDFriend,ref pFriendGameInfo);
    return result;
}
public override string GetFriendPersonaNameHistory(ulong steamIDFriend,int iPersonaName)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetFriendPersonaNameHistory(m_pSteamFriends,steamIDFriend,iPersonaName);
    return InteropHelp.IntPtrToUTF8(result);
}
public override int GetFriendSteamLevel(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendSteamLevel(m_pSteamFriends,steamIDFriend);
    return result;
}
public override string GetPlayerNickname(ulong steamIDPlayer)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetPlayerNickname(m_pSteamFriends,steamIDPlayer);
    return InteropHelp.IntPtrToUTF8(result);
}
public override int GetFriendsGroupCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendsGroupCount(m_pSteamFriends);
    return result;
}
public override char GetFriendsGroupIDByIndex(int iFG)
{
    CheckIfUsable();
    char result = NativeCalls.SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex(m_pSteamFriends,iFG);
    return result;
}
public override string GetFriendsGroupName(char friendsGroupID)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetFriendsGroupName(m_pSteamFriends,friendsGroupID);
    return InteropHelp.IntPtrToUTF8(result);
}
public override int GetFriendsGroupMembersCount(char friendsGroupID)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendsGroupMembersCount(m_pSteamFriends,friendsGroupID);
    return result;
}
public override void GetFriendsGroupMembersList(char friendsGroupID,out ulong [] pOutSteamIDMembers)
{
    CheckIfUsable();
    int nMembersCount = GetFriendsGroupMembersCount (friendsGroupID);
    pOutSteamIDMembers = new ulong[nMembersCount];
    NativeCalls.SteamAPI_ISteamFriends_GetFriendsGroupMembersList(m_pSteamFriends,friendsGroupID,pOutSteamIDMembers,nMembersCount);
}
public override bool HasFriend(ulong steamIDFriend,int iFriendFlags)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_HasFriend(m_pSteamFriends,steamIDFriend,iFriendFlags);
    return result;
}
public override int GetClanCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetClanCount(m_pSteamFriends);
    return result;
}
public override ulong GetClanByIndex(int iClan)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetClanByIndex(m_pSteamFriends,iClan);
    return result;
}
public override string GetClanName(ulong steamIDClan)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetClanName(m_pSteamFriends,steamIDClan);
    return InteropHelp.IntPtrToUTF8(result);
}
public override string GetClanTag(ulong steamIDClan)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetClanTag(m_pSteamFriends,steamIDClan);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool GetClanActivityCounts(ulong steamIDClan,ref int pnOnline,ref int pnInGame,ref int pnChatting)
{
    ...
    pnInGame = 0;
    pnChatting = 0;
    bool result = NativeCalls.SteamAPI_ISteamFriends_GetClanActivityCounts(m_pSteamFriends,steamIDClan,ref pnOnline,ref pnInGame,ref pnChatting);
    return result;
}
public override ulong DownloadClanActivityCounts(ulong [] psteamIDClans)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_DownloadClanActivityCounts(m_pSteamFriends,psteamIDClans,(int) psteamIDClans.Length);
    return result;
}
public override int GetFriendCountFromSource(ulong steamIDSource)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendCountFromSource(m_pSteamFriends,steamIDSource);
    return result;
}
public override ulong GetFriendFromSourceByIndex(ulong steamIDSource,int iFriend)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetFriendFromSourceByIndex(m_pSteamFriends,steamIDSource,iFriend);
    return result;
}
public override bool IsUserInSource(ulong steamIDUser,ulong steamIDSource)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_IsUserInSource(m_pSteamFriends,steamIDUser,steamIDSource);
    return result;
}
public override void SetInGameVoiceSpeaking(ulong steamIDUser, bool bSpeaking)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_SetInGameVoiceSpeaking(m_pSteamFriends, steamIDUser, bSpeaking);
}
public override void ActivateGameOverlay(string pchDialog)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ActivateGameOverlay(m_pSteamFriends,pchDialog);
}
public override void ActivateGameOverlayToUser(string pchDialog,ulong steamID)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ActivateGameOverlayToUser(m_pSteamFriends,pchDialog,steamID);
}
public override void ActivateGameOverlayToWebPage(string pchURL)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage(m_pSteamFriends,pchURL);
}
public override void ActivateGameOverlayToStore(uint nAppID, EOverlayToStoreFlag eFlag)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ActivateGameOverlayToStore(m_pSteamFriends, nAppID, eFlag);
}
public override void SetPlayedWith(ulong steamIDUserPlayedWith)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_SetPlayedWith(m_pSteamFriends,steamIDUserPlayedWith);
}
public override void ActivateGameOverlayInviteDialog(ulong steamIDLobby)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog(m_pSteamFriends,steamIDLobby);
}
public override int GetSmallFriendAvatar(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetSmallFriendAvatar(m_pSteamFriends,steamIDFriend);
    return result;
}
public override int GetMediumFriendAvatar(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetMediumFriendAvatar(m_pSteamFriends,steamIDFriend);
    return result;
}
public override int GetLargeFriendAvatar(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetLargeFriendAvatar(m_pSteamFriends,steamIDFriend);
    return result;
}
public override bool RequestUserInformation(ulong steamIDUser,bool bRequireNameOnly)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_RequestUserInformation(m_pSteamFriends,steamIDUser,bRequireNameOnly);
    return result;
}
public override ulong RequestClanOfficerList(ulong steamIDClan)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_RequestClanOfficerList(m_pSteamFriends,steamIDClan);
    return result;
}
public override ulong GetClanOwner(ulong steamIDClan)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetClanOwner(m_pSteamFriends,steamIDClan);
    return result;
}
public override int GetClanOfficerCount(ulong steamIDClan)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetClanOfficerCount(m_pSteamFriends,steamIDClan);
    return result;
}
public override ulong GetClanOfficerByIndex(ulong steamIDClan,int iOfficer)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetClanOfficerByIndex(m_pSteamFriends,steamIDClan,iOfficer);
    return result;
}
public override uint GetUserRestrictions()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamFriends_GetUserRestrictions(m_pSteamFriends);
    return result;
}
public override bool SetRichPresence(string pchKey,string pchValue)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_SetRichPresence(m_pSteamFriends,pchKey,pchValue);
    return result;
}
public override void ClearRichPresence()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_ClearRichPresence(m_pSteamFriends);
}
public override string GetFriendRichPresence(ulong steamIDFriend,string pchKey)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetFriendRichPresence(m_pSteamFriends,steamIDFriend,pchKey);
    return InteropHelp.IntPtrToUTF8(result);
}
public override int GetFriendRichPresenceKeyCount(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount(m_pSteamFriends,steamIDFriend);
    return result;
}
public override string GetFriendRichPresenceKeyByIndex(ulong steamIDFriend,int iKey)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex(m_pSteamFriends,steamIDFriend,iKey);
    return InteropHelp.IntPtrToUTF8(result);
}
public override void RequestFriendRichPresence(ulong steamIDFriend)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamFriends_RequestFriendRichPresence(m_pSteamFriends,steamIDFriend);
}
public override bool InviteUserToGame(ulong steamIDFriend,string pchConnectString)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_InviteUserToGame(m_pSteamFriends,steamIDFriend,pchConnectString);
    return result;
}
public override int GetCoplayFriendCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetCoplayFriendCount(m_pSteamFriends);
    return result;
}
public override ulong GetCoplayFriend(int iCoplayFriend)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetCoplayFriend(m_pSteamFriends,iCoplayFriend);
    return result;
}
public override int GetFriendCoplayTime(ulong steamIDFriend)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendCoplayTime(m_pSteamFriends,steamIDFriend);
    return result;
}
public override uint GetFriendCoplayGame(ulong steamIDFriend)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamFriends_GetFriendCoplayGame(m_pSteamFriends,steamIDFriend);
    return result;
}
public override ulong JoinClanChatRoom(ulong steamIDClan)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_JoinClanChatRoom(m_pSteamFriends,steamIDClan);
    return result;
}
public override bool LeaveClanChatRoom(ulong steamIDClan)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_LeaveClanChatRoom(m_pSteamFriends,steamIDClan);
    return result;
}
public override int GetClanChatMemberCount(ulong steamIDClan)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetClanChatMemberCount(m_pSteamFriends,steamIDClan);
    return result;
}
public override ulong GetChatMemberByIndex(ulong steamIDClan,int iUser)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetChatMemberByIndex(m_pSteamFriends,steamIDClan,iUser);
    return result;
}
public override bool SendClanChatMessage(ulong steamIDClanChat,string pchText)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_SendClanChatMessage(m_pSteamFriends,steamIDClanChat,pchText);
    return result;
}
public override int GetClanChatMessage(ulong steamIDClanChat,int iMessage,IntPtr prgchText,int cchTextMax,ref uint peChatEntryType,out ulong psteamidChatter)
{
    CheckIfUsable();
    peChatEntryType = 0;
    psteamidChatter = new ulong();
    int result = NativeCalls.SteamAPI_ISteamFriends_GetClanChatMessage(m_pSteamFriends,steamIDClanChat,iMessage,prgchText,cchTextMax,ref peChatEntryType,ref psteamidChatter);
    return result;
}
public override bool IsClanChatAdmin(ulong steamIDClanChat,ulong steamIDUser)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_IsClanChatAdmin(m_pSteamFriends,steamIDClanChat,steamIDUser);
    return result;
}
public override bool IsClanChatWindowOpenInSteam(ulong steamIDClanChat)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_IsClanChatWindowOpenInSteam(m_pSteamFriends,steamIDClanChat);
    return result;
}
public override bool OpenClanChatWindowInSteam(ulong steamIDClanChat)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_OpenClanChatWindowInSteam(m_pSteamFriends,steamIDClanChat);
    return result;
}
public override bool CloseClanChatWindowInSteam(ulong steamIDClanChat)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_CloseClanChatWindowInSteam(m_pSteamFriends,steamIDClanChat);
    return result;
}
public override bool SetListenForFriendsMessages(bool bInterceptEnabled)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_SetListenForFriendsMessages(m_pSteamFriends,bInterceptEnabled);
    return result;
}
public override bool ReplyToFriendMessage(ulong steamIDFriend,string pchMsgToSend)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamFriends_ReplyToFriendMessage(m_pSteamFriends,steamIDFriend,pchMsgToSend);
    return result;
}
public override int GetFriendMessage(ulong steamIDFriend,int iMessageID,IntPtr pvData,int cubData,ref uint peChatEntryType)
{
    CheckIfUsable();
    peChatEntryType = 0;
    int result = NativeCalls.SteamAPI_ISteamFriends_GetFriendMessage(m_pSteamFriends,steamIDFriend,iMessageID,pvData,cubData,ref peChatEntryType);
    return result;
}
public override ulong GetFollowerCount(ulong steamID)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_GetFollowerCount(m_pSteamFriends,steamID);
    return result;
}
public override ulong IsFollowing(ulong steamID)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_IsFollowing(m_pSteamFriends,steamID);
    return result;
}
public override ulong EnumerateFollowingList(uint unStartIndex)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamFriends_EnumerateFollowingList(m_pSteamFriends,unStartIndex);
    return result;
}
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetSecondsSinceAppActive(m_pSteamUtils);
    return result;
}
public override uint GetSecondsSinceComputerActive()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetSecondsSinceComputerActive(m_pSteamUtils);
    return result;
}
public override int GetConnectedUniverse()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUtils_GetConnectedUniverse(m_pSteamUtils);
    return result;
}
public override uint GetServerRealTime()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetServerRealTime(m_pSteamUtils);
    return result;
}
public override string GetIPCountry()
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamUtils_GetIPCountry(m_pSteamUtils);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool GetImageSize(int iImage,ref uint pnWidth,ref uint pnHeight)
{
    ...
    pnWidth = 0;
    pnHeight = 0;
    bool result = NativeCalls.SteamAPI_ISteamUtils_GetImageSize(m_pSteamUtils,iImage,ref pnWidth,ref pnHeight);
    return result;
}
public override bool GetImageRGBA(int iImage, byte[] pubDest, int nDestBufferSize)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUtils_GetImageRGBA(m_pSteamUtils, iImage, pubDest, nDestBufferSize);
    return result;
}
public override bool GetCSERIPPort(ref uint unIP,ref char usPort)
{
    ...
    unIP = 0;
    usPort = (char) 0;
    bool result = NativeCalls.SteamAPI_ISteamUtils_GetCSERIPPort(m_pSteamUtils,ref unIP,ref usPort);
    return result;
}
public override byte GetCurrentBatteryPower()
{
    CheckIfUsable();
    byte result = NativeCalls.SteamAPI_ISteamUtils_GetCurrentBatteryPower(m_pSteamUtils);
    return result;
}
public override uint GetAppID()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetAppID(m_pSteamUtils);
    return result;
}
public override void SetOverlayNotificationPosition(uint eNotificationPosition)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUtils_SetOverlayNotificationPosition(m_pSteamUtils,eNotificationPosition);
}
public override bool IsAPICallCompleted(ulong hSteamAPICall,ref bool pbFailed)
{
    CheckIfUsable();
    pbFailed = false;
    bool result = NativeCalls.SteamAPI_ISteamUtils_IsAPICallCompleted(m_pSteamUtils,hSteamAPICall,ref pbFailed);
    return result;
}
public override int GetAPICallFailureReason(ulong hSteamAPICall)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUtils_GetAPICallFailureReason(m_pSteamUtils,hSteamAPICall);
    return result;
}
public override bool GetAPICallResult(ulong hSteamAPICall,IntPtr pCallback,int cubCallback,int iCallbackExpected,ref bool pbFailed)
{
    CheckIfUsable();
    pbFailed = false;
    bool result = NativeCalls.SteamAPI_ISteamUtils_GetAPICallResult(m_pSteamUtils,hSteamAPICall,pCallback,cubCallback,iCallbackExpected,ref pbFailed);
    return result;
}
public override void RunFrame()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUtils_RunFrame(m_pSteamUtils);
}
public override uint GetIPCCallCount()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetIPCCallCount(m_pSteamUtils);
    return result;
}
public override void SetWarningMessageHook(SteamWarningMessageHookDelegate pFunction)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUtils_SetWarningMessageHook(m_pSteamUtils,pFunction);
}
public override bool IsOverlayEnabled()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUtils_IsOverlayEnabled(m_pSteamUtils);
    return result;
}
public override bool BOverlayNeedsPresent()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUtils_BOverlayNeedsPresent(m_pSteamUtils);
    return result;
}
public override ulong CheckFileSignature(string szFileName)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUtils_CheckFileSignature(m_pSteamUtils,szFileName);
    return result;
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUtils_GetEnteredGamepadTextLength(m_pSteamUtils);
    return result;
}
public override bool GetEnteredGamepadTextInput(string pchText,uint cchText)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUtils_GetEnteredGamepadTextInput(m_pSteamUtils,pchText,cchText);
    return result;
}
public override string GetSteamUILanguage()
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamUtils_GetSteamUILanguage(m_pSteamUtils);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool IsSteamRunningInVR()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUtils_IsSteamRunningInVR(m_pSteamUtils);
    return result;
}
public override void SetOverlayNotificationInset(int nHorizontalInset,int nVerticalInset)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamUtils_SetOverlayNotificationInset(m_pSteamUtils,nHorizontalInset,nVerticalInset);
}
}
...
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_GetFavoriteGameCount(m_pSteamMatchmaking);
    return result;
}
public override bool GetFavoriteGame(int iGame,ref uint pnAppID,ref uint pnIP,ref char pnConnPort,ref char pnQueryPort,ref uint punFlags,ref uint pRTime32LastPlayedOnServer)
{
    ...
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_GetFavoriteGame(m_pSteamMatchmaking,iGame,ref pnAppID,ref pnIP,ref pnConnPort,ref pnQueryPort,ref punFlags,ref pRTime32LastPlayedOnServer);
    return result;
}
...
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_AddFavoriteGame(m_pSteamMatchmaking,nAppID,nIP,nConnPort,nQueryPort,unFlags,rTime32LastPlayedOnServer);
    return result;
}
public override bool RemoveFavoriteGame(uint nAppID,uint nIP,char nConnPort,char nQueryPort,uint unFlags)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_RemoveFavoriteGame(m_pSteamMatchmaking,nAppID,nIP,nConnPort,nQueryPort,unFlags);
    return result;
}
public override ulong RequestLobbyList()
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_RequestLobbyList(m_pSteamMatchmaking);
    return result;
}
public override void AddRequestLobbyListStringFilter(string pchKeyToMatch,string pchValueToMatch,ELobbyComparison eComparisonType)
{
    CheckIfUsable();
    IntPtr pchKeyToMatchCstr = Marshal.StringToHGlobalAnsi(pchKeyToMatch);
    IntPtr pchValueToMatchCstr = Marshal.StringToHGlobalAnsi(pchValueToMatch);
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter(m_pSteamMatchmaking,pchKeyToMatchCstr,pchValueToMatchCstr,eComparisonType);
    Marshal.FreeHGlobal(pchKeyToMatchCstr);
    Marshal.FreeHGlobal(pchValueToMatchCstr);
}
public override void AddRequestLobbyListNumericalFilter(string pchKeyToMatch,int nValueToMatch,uint eComparisonType)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter(m_pSteamMatchmaking,pchKeyToMatch,nValueToMatch,eComparisonType);
}
public override void AddRequestLobbyListNearValueFilter(string pchKeyToMatch,int nValueToBeCloseTo)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter(m_pSteamMatchmaking,pchKeyToMatch,nValueToBeCloseTo);
}
public override void AddRequestLobbyListFilterSlotsAvailable(int nSlotsAvailable)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable(m_pSteamMatchmaking,nSlotsAvailable);
}
public override void AddRequestLobbyListDistanceFilter(uint eLobbyDistanceFilter)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter(m_pSteamMatchmaking,eLobbyDistanceFilter);
}
public override void AddRequestLobbyListResultCountFilter(int cMaxResults)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter(m_pSteamMatchmaking,cMaxResults);
}
public override void AddRequestLobbyListCompatibleMembersFilter(ulong steamIDLobby)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter(m_pSteamMatchmaking,steamIDLobby);
}
public override ulong GetLobbyByIndex(int iLobby)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyByIndex(m_pSteamMatchmaking,iLobby);
    return result;
}
public override ulong CreateLobby(ELobbyType eLobbyType,int cMaxMembers)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_CreateLobby(m_pSteamMatchmaking, eLobbyType, cMaxMembers);
    return result;
}
public override ulong JoinLobby(ulong steamIDLobby)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_JoinLobby(m_pSteamMatchmaking,steamIDLobby);
    return result;
}
public override void LeaveLobby(ulong steamIDLobby)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_LeaveLobby(m_pSteamMatchmaking,steamIDLobby);
}
public override bool InviteUserToLobby(ulong steamIDLobby,ulong steamIDInvitee)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_InviteUserToLobby(m_pSteamMatchmaking,steamIDLobby,steamIDInvitee);
    return result;
}
public override int GetNumLobbyMembers(ulong steamIDLobby)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_GetNumLobbyMembers(m_pSteamMatchmaking,steamIDLobby);
    return result;
}
public override ulong GetLobbyMemberByIndex(ulong steamIDLobby,int iMember)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyMemberByIndex(m_pSteamMatchmaking,steamIDLobby,iMember);
    return result;
}
public override string GetLobbyData(ulong steamIDLobby, string pchKey)
{
    CheckIfUsable();
    IntPtr pchKeyCstr = Marshal.StringToHGlobalAnsi(pchKey);
    IntPtr result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyData(m_pSteamMatchmaking, steamIDLobby, pchKeyCstr);
    Marshal.FreeHGlobal(pchKeyCstr);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool SetLobbyData(ulong steamIDLobby, string pchKey, string pchValue)
{
    CheckIfUsable();
    IntPtr pchKeyCstr = Marshal.StringToHGlobalAnsi(pchKey);
    IntPtr pchValueCstr = Marshal.StringToHGlobalAnsi(pchValue);
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyData(m_pSteamMatchmaking, steamIDLobby, pchKeyCstr, pchValueCstr);
    Marshal.FreeHGlobal(pchKeyCstr);
    Marshal.FreeHGlobal(pchValueCstr);
    return result;
}
public override int GetLobbyDataCount(ulong steamIDLobby)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyDataCount(m_pSteamMatchmaking,steamIDLobby);
    return result;
}
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyDataByIndex(m_pSteamMatchmaking,steamIDLobby,iLobbyData,pchKey,cchKeyBufferSize,pchValue,cchValueBufferSize);
    return result;
}
public override bool DeleteLobbyData(ulong steamIDLobby,string pchKey)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_DeleteLobbyData(m_pSteamMatchmaking,steamIDLobby,pchKey);
    return result;
}
public override string GetLobbyMemberData(ulong steamIDLobby,ulong steamIDUser,string pchKey)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyMemberData(m_pSteamMatchmaking,steamIDLobby,steamIDUser,pchKey);
    return InteropHelp.IntPtrToUTF8(result);
}
public override void SetLobbyMemberData(ulong steamIDLobby,string pchKey,string pchValue)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyMemberData(m_pSteamMatchmaking,steamIDLobby,pchKey,pchValue);
}
public override bool SendLobbyChatMsg(ulong steamIDLobby, byte[] pvMsgBody, int cubMsgBody)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SendLobbyChatMsg(m_pSteamMatchmaking, steamIDLobby, pvMsgBody, cubMsgBody);
    return result;
}
public override int GetLobbyChatEntry(ulong steamIDLobby, int iChatID, out ulong pSteamIDUser, byte[] pvData, int cubData, out EChatEntryType peChatEntryType)
{
    CheckIfUsable();
    pSteamIDUser = new ulong();
    peChatEntryType = 0;
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyChatEntry(m_pSteamMatchmaking, steamIDLobby, iChatID, out pSteamIDUser, pvData, cubData, out peChatEntryType);
    return result;
}
public override bool RequestLobbyData(ulong steamIDLobby)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_RequestLobbyData(m_pSteamMatchmaking,steamIDLobby);
    return result;
}
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyGameServer(m_pSteamMatchmaking,steamIDLobby,unGameServerIP,unGameServerPort,steamIDGameServer);
}
public override bool GetLobbyGameServer(ulong steamIDLobby,ref uint punGameServerIP,ref char punGameServerPort,out ulong psteamIDGameServer)
{
    CheckIfUsable();
    punGameServerIP = 0;
    punGameServerPort = (char) 0;
    psteamIDGameServer = new ulong();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyGameServer(m_pSteamMatchmaking,steamIDLobby,ref punGameServerIP,ref punGameServerPort,ref psteamIDGameServer);
    return result;
}
public override bool SetLobbyMemberLimit(ulong steamIDLobby,int cMaxMembers)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyMemberLimit(m_pSteamMatchmaking,steamIDLobby,cMaxMembers);
    return result;
}
public override int GetLobbyMemberLimit(ulong steamIDLobby)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyMemberLimit(m_pSteamMatchmaking,steamIDLobby);
    return result;
}
public override bool SetLobbyType(ulong steamIDLobby,uint eLobbyType)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyType(m_pSteamMatchmaking,steamIDLobby,eLobbyType);
    return result;
}
public override bool SetLobbyJoinable(ulong steamIDLobby,bool bLobbyJoinable)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyJoinable(m_pSteamMatchmaking,steamIDLobby,bLobbyJoinable);
    return result;
}
public override ulong GetLobbyOwner(ulong steamIDLobby)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamMatchmaking_GetLobbyOwner(m_pSteamMatchmaking, steamIDLobby);
    return result;
}
public override bool SetLobbyOwner(ulong steamIDLobby, ulong steamIDNewOwner)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLobbyOwner(m_pSteamMatchmaking, steamIDLobby, steamIDNewOwner);
    return result;
}
public override bool SetLinkedLobby(ulong steamIDLobby,ulong steamIDLobbyDependent)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmaking_SetLinkedLobby(m_pSteamMatchmaking,steamIDLobby,steamIDLobbyDependent);
    return result;
}
}
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServerListResponse_ServerResponded(m_pSteamMatchmakingServerListResponse,hRequest,iServer);
}
public override void ServerFailedToRespond(uint hRequest,int iServer)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServerListResponse_ServerFailedToRespond(m_pSteamMatchmakingServerListResponse,hRequest,iServer);
}
public override void RefreshComplete(uint hRequest,uint response)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServerListResponse_RefreshComplete(m_pSteamMatchmakingServerListResponse,hRequest,response);
}
}
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingPingResponse_ServerResponded(m_pSteamMatchmakingPingResponse,server);
}
public override void ServerFailedToRespond()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond(m_pSteamMatchmakingPingResponse);
}
}
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList(m_pSteamMatchmakingPlayersResponse,pchName,nScore,flTimePlayed);
}
public override void PlayersFailedToRespond()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond(m_pSteamMatchmakingPlayersResponse);
}
public override void PlayersRefreshComplete()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete(m_pSteamMatchmakingPlayersResponse);
}
}
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded(m_pSteamMatchmakingRulesResponse,pchRule,pchValue);
}
public override void RulesFailedToRespond()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond(m_pSteamMatchmakingRulesResponse);
}
public override void RulesRefreshComplete()
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete(m_pSteamMatchmakingRulesResponse);
}
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestInternetServerList(m_pSteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
    return result;
}
public override uint RequestLANServerList(uint iApp,ISteamMatchmakingServerListResponse pRequestServersResponse)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestLANServerList(m_pSteamMatchmakingServers,iApp,pRequestServersResponse.GetIntPtr());
    return result;
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList(m_pSteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
    return result;
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList(m_pSteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
    return result;
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList(m_pSteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
    return result;
}
...
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList(m_pSteamMatchmakingServers,iApp,ppchFilters,(uint) ppchFilters.Length,pRequestServersResponse.GetIntPtr());
    return result;
}
public override void ReleaseRequest(uint hServerListRequest)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServers_ReleaseRequest(m_pSteamMatchmakingServers,hServerListRequest);
}
public override gameserveritem_t GetServerDetails(uint hRequest,int iServer)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamMatchmakingServers_GetServerDetails(m_pSteamMatchmakingServers,hRequest,iServer);
...
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServers_CancelQuery(m_pSteamMatchmakingServers,hRequest);
}
public override void RefreshQuery(uint hRequest)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServers_RefreshQuery(m_pSteamMatchmakingServers,hRequest);
}
public override bool IsRefreshing(uint hRequest)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamMatchmakingServers_IsRefreshing(m_pSteamMatchmakingServers,hRequest);
    return result;
}
public override int GetServerCount(uint hRequest)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamMatchmakingServers_GetServerCount(m_pSteamMatchmakingServers,hRequest);
    return result;
}
public override void RefreshServer(uint hRequest,int iServer)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServers_RefreshServer(m_pSteamMatchmakingServers,hRequest,iServer);
}
public override uint PingServer(uint unIP,char usPort,ISteamMatchmakingPingResponse pRequestServersResponse)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_PingServer(m_pSteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
    return result;
}
public override uint PlayerDetails(uint unIP,char usPort,ISteamMatchmakingPlayersResponse pRequestServersResponse)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_PlayerDetails(m_pSteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
    return result;
}
public override uint ServerRules(uint unIP,char usPort,ISteamMatchmakingRulesResponse pRequestServersResponse)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamMatchmakingServers_ServerRules(m_pSteamMatchmakingServers,unIP,usPort,pRequestServersResponse.GetIntPtr());
    return result;
}
public override void CancelServerQuery(uint hServerQuery)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamMatchmakingServers_CancelServerQuery(m_pSteamMatchmakingServers,hServerQuery);
}
}
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWrite(m_pSteamRemoteStorage,pchFile,pvData,cubData);
    return result;
}
public override int FileRead(string pchFile,IntPtr pvData,int cubDataToRead)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileRead(m_pSteamRemoteStorage,pchFile,pvData,cubDataToRead);
    return result;
}
public override ulong FileWriteAsync(string pchFile,IntPtr pvData,uint cubData)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWriteAsync(m_pSteamRemoteStorage,pchFile,pvData,cubData);
    return result;
}
public override ulong FileReadAsync(string pchFile,uint nOffset,uint cubToRead)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileReadAsync(m_pSteamRemoteStorage,pchFile,nOffset,cubToRead);
    return result;
}
public override bool FileReadAsyncComplete(ulong hReadCall,IntPtr pvBuffer,uint cubToRead)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileReadAsyncComplete(m_pSteamRemoteStorage,hReadCall,pvBuffer,cubToRead);
    return result;
}
public override bool FileForget(string pchFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileForget(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override bool FileDelete(string pchFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileDelete(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override ulong FileShare(string pchFile)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileShare(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override bool SetSyncPlatforms(string pchFile,uint eRemoteStoragePlatform)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_SetSyncPlatforms(m_pSteamRemoteStorage,pchFile,eRemoteStoragePlatform);
    return result;
}
public override ulong FileWriteStreamOpen(string pchFile)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override bool FileWriteStreamWriteChunk(ulong writeHandle,IntPtr pvData,int cubData)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk(m_pSteamRemoteStorage,writeHandle,pvData,cubData);
    return result;
}
public override bool FileWriteStreamClose(ulong writeHandle)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWriteStreamClose(m_pSteamRemoteStorage,writeHandle);
    return result;
}
public override bool FileWriteStreamCancel(ulong writeHandle)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileWriteStreamCancel(m_pSteamRemoteStorage,writeHandle);
    return result;
}
public override bool FileExists(string pchFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FileExists(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override bool FilePersisted(string pchFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_FilePersisted(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override int GetFileSize(string pchFile)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetFileSize(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override long GetFileTimestamp(string pchFile)
{
    CheckIfUsable();
    long result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetFileTimestamp(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override uint GetSyncPlatforms(string pchFile)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetSyncPlatforms(m_pSteamRemoteStorage,pchFile);
    return result;
}
public override int GetFileCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetFileCount(m_pSteamRemoteStorage);
    return result;
}
public override string GetFileNameAndSize(int iFile,ref int pnFileSizeInBytes)
{
    CheckIfUsable();
    pnFileSizeInBytes = 0;
    IntPtr result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetFileNameAndSize(m_pSteamRemoteStorage,iFile,ref pnFileSizeInBytes);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool GetQuota(ref int pnTotalBytes,ref int puAvailableBytes)
{
    ...
    pnTotalBytes = 0;
    puAvailableBytes = 0;
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetQuota(m_pSteamRemoteStorage,ref pnTotalBytes,ref puAvailableBytes);
    return result;
}
public override bool IsCloudEnabledForAccount()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_IsCloudEnabledForAccount(m_pSteamRemoteStorage);
    return result;
}
public override bool IsCloudEnabledForApp()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_IsCloudEnabledForApp(m_pSteamRemoteStorage);
    return result;
}
public override void SetCloudEnabledForApp(bool bEnabled)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamRemoteStorage_SetCloudEnabledForApp(m_pSteamRemoteStorage,bEnabled);
}
public override ulong UGCDownload(ulong hContent,uint unPriority)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_UGCDownload(m_pSteamRemoteStorage,hContent,unPriority);
    return result;
}
public override bool GetUGCDownloadProgress(ulong hContent,ref int pnBytesDownloaded,ref int pnBytesExpected)
{
    ...
    pnBytesDownloaded = 0;
    pnBytesExpected = 0;
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetUGCDownloadProgress(m_pSteamRemoteStorage,hContent,ref pnBytesDownloaded,ref pnBytesExpected);
    return result;
}
public override bool GetUGCDetails(ulong hContent,ref uint pnAppID,string ppchName,ref int pnFileSizeInBytes,out ulong pSteamIDOwner)
{
    CheckIfUsable();
    pnAppID = 0;
    ppchName = "";
    pnFileSizeInBytes = 0;
    pSteamIDOwner = new ulong();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetUGCDetails(m_pSteamRemoteStorage,hContent,ref pnAppID,ppchName,ref pnFileSizeInBytes,ref pSteamIDOwner);
    return result;
}
public override int UGCRead(ulong hContent,IntPtr pvData,int cubDataToRead,uint cOffset,uint eAction)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamRemoteStorage_UGCRead(m_pSteamRemoteStorage,hContent,pvData,cubDataToRead,cOffset,eAction);
    return result;
}
public override int GetCachedUGCCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetCachedUGCCount(m_pSteamRemoteStorage);
    return result;
}
public override ulong GetCachedUGCHandle(int iCachedContent)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle(m_pSteamRemoteStorage,iCachedContent);
    return result;
}
...
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_PublishWorkshopFile(m_pSteamRemoteStorage,pchFile,pchPreviewFile,nConsumerAppId,pchTitle,pchDescription,eVisibility,ref pTags,eWorkshopFileType);
    return result;
}
public override ulong CreatePublishedFileUpdateRequest(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_CreatePublishedFileUpdateRequest(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
public override bool UpdatePublishedFileFile(ulong updateHandle,string pchFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile(m_pSteamRemoteStorage,updateHandle,pchFile);
    return result;
}
public override bool UpdatePublishedFilePreviewFile(ulong updateHandle,string pchPreviewFile)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile(m_pSteamRemoteStorage,updateHandle,pchPreviewFile);
    return result;
}
public override bool UpdatePublishedFileTitle(ulong updateHandle,string pchTitle)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle(m_pSteamRemoteStorage,updateHandle,pchTitle);
    return result;
}
public override bool UpdatePublishedFileDescription(ulong updateHandle,string pchDescription)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription(m_pSteamRemoteStorage,updateHandle,pchDescription);
    return result;
}
public override bool UpdatePublishedFileVisibility(ulong updateHandle,uint eVisibility)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileVisibility(m_pSteamRemoteStorage,updateHandle,eVisibility);
    return result;
}
public override bool UpdatePublishedFileTags(ulong updateHandle,ref SteamParamStringArray_t pTags)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags(m_pSteamRemoteStorage,updateHandle,ref pTags);
    return result;
}
public override ulong CommitPublishedFileUpdate(ulong updateHandle)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_CommitPublishedFileUpdate(m_pSteamRemoteStorage,updateHandle);
    return result;
}
public override ulong GetPublishedFileDetails(ulong unPublishedFileId,uint unMaxSecondsOld)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetPublishedFileDetails(m_pSteamRemoteStorage,unPublishedFileId,unMaxSecondsOld);
    return result;
}
public override ulong DeletePublishedFile(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_DeletePublishedFile(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
public override ulong EnumerateUserPublishedFiles(uint unStartIndex)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_EnumerateUserPublishedFiles(m_pSteamRemoteStorage,unStartIndex);
    return result;
}
public override ulong SubscribePublishedFile(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_SubscribePublishedFile(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
public override ulong EnumerateUserSubscribedFiles(uint unStartIndex)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_EnumerateUserSubscribedFiles(m_pSteamRemoteStorage,unStartIndex);
    return result;
}
public override ulong UnsubscribePublishedFile(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_UnsubscribePublishedFile(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
public override bool UpdatePublishedFileSetChangeDescription(ulong updateHandle,string pchChangeDescription)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(m_pSteamRemoteStorage,updateHandle,pchChangeDescription);
    return result;
}
public override ulong GetPublishedItemVoteDetails(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetPublishedItemVoteDetails(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
public override ulong UpdateUserPublishedItemVote(ulong unPublishedFileId,bool bVoteUp)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_UpdateUserPublishedItemVote(m_pSteamRemoteStorage,unPublishedFileId,bVoteUp);
    return result;
}
public override ulong GetUserPublishedItemVoteDetails(ulong unPublishedFileId)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails(m_pSteamRemoteStorage,unPublishedFileId);
    return result;
}
...
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(m_pSteamRemoteStorage,steamId,unStartIndex,ref pRequiredTags,ref pExcludedTags);
    return result;
}
...
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_PublishVideo(m_pSteamRemoteStorage,eVideoProvider,pchVideoAccount,pchVideoIdentifier,pchPreviewFile,nConsumerAppId,pchTitle,pchDescription,eVisibility,ref pTags);
    return result;
}
public override ulong SetUserPublishedFileAction(ulong unPublishedFileId,uint eAction)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction(m_pSteamRemoteStorage,unPublishedFileId,eAction);
    return result;
}
public override ulong EnumeratePublishedFilesByUserAction(uint eAction,uint unStartIndex)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(m_pSteamRemoteStorage,eAction,unStartIndex);
    return result;
}
...
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(m_pSteamRemoteStorage,eEnumerationType,unStartIndex,unCount,unDays,ref pTags,ref pUserTags);
    return result;
}
public override ulong UGCDownloadToLocation(ulong hContent,string pchLocation,uint unPriority)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(m_pSteamRemoteStorage,hContent,pchLocation,unPriority);
    return result;
}
}
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_RequestCurrentStats(m_pSteamUserStats);
    return result;
}
public override bool GetStat_Int(string pchName,ref int pData)
{
    CheckIfUsable();
    pData = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetStat(m_pSteamUserStats,pchName,ref pData);
    return result;
}
public override bool GetStat_Float(string pchName,ref float pData)
{
    CheckIfUsable();
    pData = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetStat0(m_pSteamUserStats,pchName,ref pData);
    return result;
}
public override bool SetStat_Int(string pchName,int nData)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_SetStat(m_pSteamUserStats,pchName,nData);
    return result;
}
public override bool SetStat_Float(string pchName,float fData)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_SetStat0(m_pSteamUserStats,pchName,fData);
    return result;
}
public override bool UpdateAvgRateStat(string pchName,float flCountThisSession,double dSessionLength)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_UpdateAvgRateStat(m_pSteamUserStats,pchName,flCountThisSession,dSessionLength);
    return result;
}
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_SetAchievement(m_pSteamUserStats,pchName);
    return result;
}
public override bool ClearAchievement(string pchName)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_ClearAchievement(m_pSteamUserStats,pchName);
    return result;
}
public override bool GetAchievementAndUnlockTime(string pchName,ref bool pbAchieved,ref uint punUnlockTime)
{
    ...
    pbAchieved = false;
    punUnlockTime = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime(m_pSteamUserStats,pchName,ref pbAchieved,ref punUnlockTime);
    return result;
}
public override bool StoreStats()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_StoreStats(m_pSteamUserStats);
    return result;
}
public override int GetAchievementIcon(string pchName)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievementIcon(m_pSteamUserStats,pchName);
    return result;
}
public override string GetAchievementDisplayAttribute(string pchName, string pchKey)
{
    CheckIfUsable();
    IntPtr name = Marshal.StringToHGlobalAnsi(pchName);
    IntPtr key = Marshal.StringToHGlobalAnsi(pchKey);
    IntPtr result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute(m_pSteamUserStats, name, key);
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_IndicateAchievementProgress(m_pSteamUserStats,pchName,nCurProgress,nMaxProgress);
    return result;
}
public override uint GetNumAchievements()
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUserStats_GetNumAchievements(m_pSteamUserStats);
    return result;
}
public override string GetAchievementName(uint iAchievement)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievementName(m_pSteamUserStats,iAchievement);
    return InteropHelp.IntPtrToUTF8(result);
}
public override ulong RequestUserStats(ulong steamIDUser)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_RequestUserStats(m_pSteamUserStats,steamIDUser);
    return result;
}
public override bool GetUserStat_Int(ulong steamIDUser,string pchName,ref int pData)
{
    CheckIfUsable();
    pData = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetUserStat(m_pSteamUserStats,steamIDUser,pchName,ref pData);
    return result;
}
public override bool GetUserStat_Float(ulong steamIDUser,string pchName,ref float pData)
{
    CheckIfUsable();
    pData = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetUserStat0(m_pSteamUserStats,steamIDUser,pchName,ref pData);
    return result;
}
public override bool GetUserAchievement(ulong steamIDUser,string pchName,ref bool pbAchieved)
{
    CheckIfUsable();
    pbAchieved = false;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetUserAchievement(m_pSteamUserStats,steamIDUser,pchName,ref pbAchieved);
    return result;
}
public override bool GetUserAchievementAndUnlockTime(ulong steamIDUser,string pchName,ref bool pbAchieved,ref uint punUnlockTime)
{
    ...
    pbAchieved = false;
    punUnlockTime = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime(m_pSteamUserStats,steamIDUser,pchName,ref pbAchieved,ref punUnlockTime);
    return result;
}
public override bool ResetAllStats(bool bAchievementsToo)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_ResetAllStats(m_pSteamUserStats,bAchievementsToo);
    return result;
}
...
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_FindOrCreateLeaderboard(m_pSteamUserStats,pchLeaderboardName,eLeaderboardSortMethod,eLeaderboardDisplayType);
    return result;
}
...
public override bool GetAchievement(string pchName, out bool pbAchieved)
{
    CheckIfUsable();
    pbAchieved = false;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievement(m_pSteamUserStats, pchName, out pbAchieved);
    return result;
}
public override ulong FindLeaderboard(string pchLeaderboardName)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_FindLeaderboard(m_pSteamUserStats, pchLeaderboardName);
    return result;
}

public override string GetLeaderboardName(SteamLeaderboard_t hSteamLeaderboard)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamUserStats_GetLeaderboardName(m_pSteamUserStats,hSteamLeaderboard);
    return (string) Marshal.PtrToStructure(result, typeof(string));
}
public override int GetLeaderboardEntryCount(SteamLeaderboard_t hSteamLeaderboard)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetLeaderboardEntryCount(m_pSteamUserStats,hSteamLeaderboard);
    return result;
}
public override uint GetLeaderboardSortMethod(SteamLeaderboard_t hSteamLeaderboard)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUserStats_GetLeaderboardSortMethod(m_pSteamUserStats,hSteamLeaderboard);
    return result;
}
public override uint GetLeaderboardDisplayType(SteamLeaderboard_t hSteamLeaderboard)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamUserStats_GetLeaderboardDisplayType(m_pSteamUserStats,hSteamLeaderboard);
    return result;
}
       

public override ulong DownloadLeaderboardEntries(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest,int nRangeStart,int nRangeEnd)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_DownloadLeaderboardEntries(m_pSteamUserStats,hSteamLeaderboard,eLeaderboardDataRequest,nRangeStart,nRangeEnd);
    return result;
}
public override ulong DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard,ulong [] prgUsers)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers(m_pSteamUserStats,hSteamLeaderboard,prgUsers,(int) prgUsers.Length);
    return result;
}
public override bool GetDownloadedLeaderboardEntry(ulong hSteamLeaderboardEntries,int index, ref LeaderboardEntry_t pLeaderboardEntry, int[] pDetails,int cDetailsMax)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry(m_pSteamUserStats,hSteamLeaderboardEntries,index,ref pLeaderboardEntry, pDetails,cDetailsMax);
    return result;
}
public override ulong UploadLeaderboardScore(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod,int nScore, int[] pScoreDetails,int cScoreDetailsCount)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_UploadLeaderboardScore(m_pSteamUserStats,hSteamLeaderboard,  eLeaderboardUploadScoreMethod,nScore, pScoreDetails, cScoreDetailsCount);
    return result;
}
public override ulong AttachLeaderboardUGC(SteamLeaderboard_t hSteamLeaderboard,ulong hUGC)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_AttachLeaderboardUGC(m_pSteamUserStats,hSteamLeaderboard,hUGC);
    return result;
}
public override ulong GetNumberOfCurrentPlayers()
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers(m_pSteamUserStats);
    return result;
}
public override ulong RequestGlobalAchievementPercentages()
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_RequestGlobalAchievementPercentages(m_pSteamUserStats);
    return result;
}
public override int GetMostAchievedAchievementInfo(string pchName,uint unNameBufLen,ref float pflPercent,ref bool pbAchieved)
{
    ...
    pflPercent = 0;
    pbAchieved = false;
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo(m_pSteamUserStats,pchName,unNameBufLen,ref pflPercent,ref pbAchieved);
    return result;
}
public override int GetNextMostAchievedAchievementInfo(int iIteratorPrevious,string pchName,uint unNameBufLen,ref float pflPercent,ref bool pbAchieved)
{
    ...
    pflPercent = 0;
    pbAchieved = false;
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo(m_pSteamUserStats,iIteratorPrevious,pchName,unNameBufLen,ref pflPercent,ref pbAchieved);
    return result;
}
public override bool GetAchievementAchievedPercent(string pchName,ref float pflPercent)
{
    CheckIfUsable();
    pflPercent = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetAchievementAchievedPercent(m_pSteamUserStats,pchName,ref pflPercent);
    return result;
}
public override ulong RequestGlobalStats(int nHistoryDays)
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamUserStats_RequestGlobalStats(m_pSteamUserStats,nHistoryDays);
    return result;
}
public override bool GetGlobalStat(string pchStatName, out long pData)
{
    CheckIfUsable();
    pData = 0;
    using (var pchStatName2 = new InteropHelp.UTF8StringHandle(pchStatName))
    {
        return NativeCalls.SteamAPI_ISteamUserStats_GetGlobalStat(m_pSteamUserStats, pchStatName2, out pData);
    }
    //return false;
}
public override bool GetGlobalStat0(string pchStatName,ref double pData)
{
    CheckIfUsable();
    pData = 0;
    bool result = NativeCalls.SteamAPI_ISteamUserStats_GetGlobalStat0(m_pSteamUserStats,pchStatName,ref pData);
    return result;
}
public override int GetGlobalStatHistory(string pchStatName,long [] pData)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetGlobalStatHistory(m_pSteamUserStats,pchStatName,pData,(uint) pData.Length);
    return result;
}
public override int GetGlobalStatHistory0(string pchStatName,double [] pData)
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamUserStats_GetGlobalStatHistory0(m_pSteamUserStats,pchStatName,pData,(uint) pData.Length);
    return result;
}
}
...
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsSubscribed(m_pSteamApps);
    return result;
}
public override bool BIsLowViolence()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsLowViolence(m_pSteamApps);
    return result;
}
public override bool BIsCybercafe()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsCybercafe(m_pSteamApps);
    return result;
}
public override bool BIsVACBanned()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsVACBanned(m_pSteamApps);
    return result;
}
public override string GetCurrentGameLanguage()
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamApps_GetCurrentGameLanguage(m_pSteamApps);
    return InteropHelp.IntPtrToUTF8(result);
}
public override string GetAvailableGameLanguages()
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamApps_GetAvailableGameLanguages(m_pSteamApps);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool BIsSubscribedApp(uint appID)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsSubscribedApp(m_pSteamApps,appID);
    return result;
}
public override bool BIsDlcInstalled(uint appID)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsDlcInstalled(m_pSteamApps, appID);
    return result;
}
public override uint GetEarliestPurchaseUnixTime(uint nAppID)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamApps_GetEarliestPurchaseUnixTime(m_pSteamApps,nAppID);
    return result;
}
public override bool BIsSubscribedFromFreeWeekend()
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsSubscribedFromFreeWeekend(m_pSteamApps);
    return result;
}
public override int GetDLCCount()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamApps_GetDLCCount(m_pSteamApps);
    return result;
}
public override bool BGetDLCDataByIndex(int iDLC,ref uint pAppID,ref bool pbAvailable,string pchName,int cchNameBufferSize)
{
    ...
    pAppID = 0;
    pbAvailable = false;
    bool result = NativeCalls.SteamAPI_ISteamApps_BGetDLCDataByIndex(m_pSteamApps,iDLC,ref pAppID,ref pbAvailable,pchName,cchNameBufferSize);
    return result;
}
public override void InstallDLC(uint nAppID)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamApps_InstallDLC(m_pSteamApps,nAppID);
}
public override void UninstallDLC(uint nAppID)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamApps_UninstallDLC(m_pSteamApps,nAppID);
}
public override void RequestAppProofOfPurchaseKey(uint nAppID)
{
    CheckIfUsable();
    NativeCalls.SteamAPI_ISteamApps_RequestAppProofOfPurchaseKey(m_pSteamApps,nAppID);
}
public override bool GetCurrentBetaName(string pchName,int cchNameBufferSize)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_GetCurrentBetaName(m_pSteamApps,pchName,cchNameBufferSize);
    return result;
}
public override bool MarkContentCorrupt(bool bMissingFilesOnly)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_MarkContentCorrupt(m_pSteamApps,bMissingFilesOnly);
    return result;
}
public override uint GetInstalledDepots(uint appID,ref uint pvecDepots,uint cMaxDepots)
{
    CheckIfUsable();
    pvecDepots = 0;
    uint result = NativeCalls.SteamAPI_ISteamApps_GetInstalledDepots(m_pSteamApps,appID,ref pvecDepots,cMaxDepots);
    return result;
}
public override uint GetAppInstallDir(uint appID,string pchFolder,uint cchFolderBufferSize)
{
    CheckIfUsable();
    uint result = NativeCalls.SteamAPI_ISteamApps_GetAppInstallDir(m_pSteamApps,appID,pchFolder,cchFolderBufferSize);
    return result;
}
public override bool BIsAppInstalled(uint appID)
{
    CheckIfUsable();
    bool result = NativeCalls.SteamAPI_ISteamApps_BIsAppInstalled(m_pSteamApps,appID);
    return result;
}
public override ulong GetAppOwner()
{
    CheckIfUsable();
    ulong result = NativeCalls.SteamAPI_ISteamApps_GetAppOwner(m_pSteamApps);
    return result;
}
public override string GetLaunchQueryParam(string pchKey)
{
    CheckIfUsable();
    IntPtr result = NativeCalls.SteamAPI_ISteamApps_GetLaunchQueryParam(m_pSteamApps,pchKey);
    return InteropHelp.IntPtrToUTF8(result);
}
public override bool GetDlcDownloadProgress(uint nAppID,ref ulong punBytesDownloaded,ref ulong punBytesTotal)
{
    ...
    punBytesTotal = 0;
    bool result = NativeCalls.SteamAPI_ISteamApps_GetDlcDownloadProgress(m_pSteamApps,nAppID,ref punBytesDownloaded,ref punBytesTotal);
    return result;
}
public override int GetAppBuildId()
{
    CheckIfUsable();
    int result = NativeCalls.SteamAPI_ISteamApps_GetAppBuildId(m_pSteamApps);
    return result;
}
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_SendP2PPacket(m_pSteamNetworking, steamIDRemote, pubData, cubData, eP2PSendType, nChannel);
	return result;
}
public override bool IsP2PPacketAvailable(out uint pcubMsgSize, int nChannel)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_IsP2PPacketAvailable(m_pSteamNetworking, out pcubMsgSize, nChannel);
	return result;
}
public override bool ReadP2PPacket(byte[] pubDest, uint cubDest, out uint pcubMsgSize, out ulong psteamIDRemote,int nChannel)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_ReadP2PPacket(m_pSteamNetworking, pubDest, cubDest, out pcubMsgSize, out psteamIDRemote, nChannel);
	return result;
}
public override bool AcceptP2PSessionWithUser(ulong steamIDRemote)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_AcceptP2PSessionWithUser(m_pSteamNetworking, steamIDRemote);
	return result;
}
public override bool CloseP2PSessionWithUser(ulong steamIDRemote)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_CloseP2PSessionWithUser(m_pSteamNetworking,steamIDRemote);
	return result;
}
public override bool CloseP2PChannelWithUser(ulong steamIDRemote,int nChannel)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_CloseP2PChannelWithUser(m_pSteamNetworking,steamIDRemote,nChannel);
	return result;
}
public override bool GetP2PSessionState(ulong steamIDRemote,ref P2PSessionState_t pConnectionState)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_GetP2PSessionState(m_pSteamNetworking,steamIDRemote,ref pConnectionState);
	return result;
}
public override bool AllowP2PPacketRelay(bool bAllow)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_AllowP2PPacketRelay(m_pSteamNetworking,bAllow);
	return result;
}
public override uint CreateListenSocket(int nVirtualP2PPort,uint nIP,char nPort,bool bAllowUseOfPacketRelay)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamNetworking_CreateListenSocket(m_pSteamNetworking,nVirtualP2PPort,nIP,nPort,bAllowUseOfPacketRelay);
	return result;
}
...
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamNetworking_CreateP2PConnectionSocket(m_pSteamNetworking,steamIDTarget,nVirtualPort,nTimeoutSec,bAllowUseOfPacketRelay);
	return result;
}
public override uint CreateConnectionSocket(uint nIP,char nPort,int nTimeoutSec)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamNetworking_CreateConnectionSocket(m_pSteamNetworking,nIP,nPort,nTimeoutSec);
	return result;
}
public override bool DestroySocket(uint hSocket,bool bNotifyRemoteEnd)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_DestroySocket(m_pSteamNetworking,hSocket,bNotifyRemoteEnd);
	return result;
}
public override bool DestroyListenSocket(uint hSocket,bool bNotifyRemoteEnd)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_DestroyListenSocket(m_pSteamNetworking,hSocket,bNotifyRemoteEnd);
	return result;
}
public override bool SendDataOnSocket(uint hSocket,IntPtr pubData,uint cubData,bool bReliable)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamNetworking_SendDataOnSocket(m_pSteamNetworking,hSocket,pubData,cubData,bReliable);
	return result;
}
public override bool IsDataAvailableOnSocket(uint hSocket,ref uint pcubMsgSize)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_IsDataAvailableOnSocket(m_pSteamNetworking,hSocket,ref pcubMsgSize);
	return result;
}
public override bool RetrieveDataFromSocket(uint hSocket,IntPtr pubDest,uint cubDest,ref uint pcubMsgSize)
{
	CheckIfUsable();
	pcubMsgSize = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_RetrieveDataFromSocket(m_pSteamNetworking,hSocket,pubDest,cubDest,ref pcubMsgSize);
	return result;
}
public override bool IsDataAvailable(uint hListenSocket,ref uint pcubMsgSize,ref uint phSocket)
{
	...
	pcubMsgSize = 0;
	phSocket = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_IsDataAvailable(m_pSteamNetworking,hListenSocket,ref pcubMsgSize,ref phSocket);
	return result;
}
public override bool RetrieveData(uint hListenSocket,IntPtr pubDest,uint cubDest,ref uint pcubMsgSize,ref uint phSocket)
{
	...
	pcubMsgSize = 0;
	phSocket = 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_RetrieveData(m_pSteamNetworking,hListenSocket,pubDest,cubDest,ref pcubMsgSize,ref phSocket);
	return result;
}
public override bool GetSocketInfo(uint hSocket,ref ulong pSteamIDRemote,ref int peSocketStatus,ref uint punIPRemote,ref char punPortRemote)
{
	CheckIfUsable();
	peSocketStatus = 0;
	punIPRemote = 0;
	punPortRemote = (char) 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_GetSocketInfo(m_pSteamNetworking,hSocket,ref pSteamIDRemote,ref peSocketStatus,ref punIPRemote,ref punPortRemote);
	return result;
}
public override bool GetListenSocketInfo(uint hListenSocket,ref uint pnIP,ref char pnPort)
{
	...
	pnIP = 0;
	pnPort = (char) 0;
	bool result = NativeCalls.SteamAPI_ISteamNetworking_GetListenSocketInfo(m_pSteamNetworking,hListenSocket,ref pnIP,ref pnPort);
	return result;
}
public override uint GetSocketConnectionType(uint hSocket)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamNetworking_GetSocketConnectionType(m_pSteamNetworking,hSocket);
	return result;
}
public override int GetMaxPacketSize(uint hSocket)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamNetworking_GetMaxPacketSize(m_pSteamNetworking,hSocket);
	return result;
}
}
...
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamScreenshots_WriteScreenshot(m_pSteamScreenshots,pubRGB,cubRGB,nWidth,nHeight);
	return result;
}
public override uint AddScreenshotToLibrary(string pchFilename,string pchThumbnailFilename,int nWidth,int nHeight)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamScreenshots_AddScreenshotToLibrary(m_pSteamScreenshots,pchFilename,pchThumbnailFilename,nWidth,nHeight);
	return result;
}
public override void TriggerScreenshot()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamScreenshots_TriggerScreenshot(m_pSteamScreenshots);
}
public override void HookScreenshots(bool bHook)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamScreenshots_HookScreenshots(m_pSteamScreenshots,bHook);
}
public override bool SetLocation(uint hScreenshot,string pchLocation)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamScreenshots_SetLocation(m_pSteamScreenshots,hScreenshot,pchLocation);
	return result;
}
public override bool TagUser(uint hScreenshot,ulong steamID)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamScreenshots_TagUser(m_pSteamScreenshots,hScreenshot,steamID);
	return result;
}
public override bool TagPublishedFile(uint hScreenshot,ulong unPublishedFileID)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamScreenshots_TagPublishedFile(m_pSteamScreenshots,hScreenshot,unPublishedFileID);
	return result;
}
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusic_BIsEnabled(m_pSteamMusic);
	return result;
}
public override bool BIsPlaying()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusic_BIsPlaying(m_pSteamMusic);
	return result;
}
public override int GetPlaybackStatus()
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamMusic_GetPlaybackStatus(m_pSteamMusic);
	return result;
}
public override void Play()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamMusic_Play(m_pSteamMusic);
}
public override void Pause()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamMusic_Pause(m_pSteamMusic);
}
public override void PlayPrevious()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamMusic_PlayPrevious(m_pSteamMusic);
}
public override void PlayNext()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamMusic_PlayNext(m_pSteamMusic);
}
public override void SetVolume(float flVolume)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamMusic_SetVolume(m_pSteamMusic,flVolume);
}
public override float GetVolume()
{
	CheckIfUsable();
	float result = NativeCalls.SteamAPI_ISteamMusic_GetVolume(m_pSteamMusic);
	return result;
}
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_RegisterSteamMusicRemote(m_pSteamMusicRemote,pchName);
	return result;
}
public override bool DeregisterSteamMusicRemote()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_DeregisterSteamMusicRemote(m_pSteamMusicRemote);
	return result;
}
public override bool BIsCurrentMusicRemote()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_BIsCurrentMusicRemote(m_pSteamMusicRemote);
	return result;
}
public override bool BActivationSuccess(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_BActivationSuccess(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool SetDisplayName(string pchDisplayName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetDisplayName(m_pSteamMusicRemote,pchDisplayName);
	return result;
}
public override bool SetPNGIcon_64x64(IntPtr pvBuffer,uint cbBufferLength)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetPNGIcon_64x64(m_pSteamMusicRemote,pvBuffer,cbBufferLength);
	return result;
}
public override bool EnablePlayPrevious(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnablePlayPrevious(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool EnablePlayNext(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnablePlayNext(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool EnableShuffled(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnableShuffled(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool EnableLooped(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnableLooped(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool EnableQueue(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnableQueue(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool EnablePlaylists(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_EnablePlaylists(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool UpdatePlaybackStatus(int nStatus)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdatePlaybackStatus(m_pSteamMusicRemote,nStatus);
	return result;
}
public override bool UpdateShuffled(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateShuffled(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool UpdateLooped(bool bValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateLooped(m_pSteamMusicRemote,bValue);
	return result;
}
public override bool UpdateVolume(float flValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateVolume(m_pSteamMusicRemote,flValue);
	return result;
}
public override bool CurrentEntryWillChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_CurrentEntryWillChange(m_pSteamMusicRemote);
	return result;
}
public override bool CurrentEntryIsAvailable(bool bAvailable)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_CurrentEntryIsAvailable(m_pSteamMusicRemote,bAvailable);
	return result;
}
public override bool UpdateCurrentEntryText(string pchText)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryText(m_pSteamMusicRemote,pchText);
	return result;
}
public override bool UpdateCurrentEntryElapsedSeconds(int nValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryElapsedSeconds(m_pSteamMusicRemote,nValue);
	return result;
}
public override bool UpdateCurrentEntryCoverArt(IntPtr pvBuffer,uint cbBufferLength)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryCoverArt(m_pSteamMusicRemote,pvBuffer,cbBufferLength);
	return result;
}
public override bool CurrentEntryDidChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_CurrentEntryDidChange(m_pSteamMusicRemote);
	return result;
}
public override bool QueueWillChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_QueueWillChange(m_pSteamMusicRemote);
	return result;
}
public override bool ResetQueueEntries()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_ResetQueueEntries(m_pSteamMusicRemote);
	return result;
}
public override bool SetQueueEntry(int nID,int nPosition,string pchEntryText)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetQueueEntry(m_pSteamMusicRemote,nID,nPosition,pchEntryText);
	return result;
}
public override bool SetCurrentQueueEntry(int nID)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetCurrentQueueEntry(m_pSteamMusicRemote,nID);
	return result;
}
public override bool QueueDidChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_QueueDidChange(m_pSteamMusicRemote);
	return result;
}
public override bool PlaylistWillChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_PlaylistWillChange(m_pSteamMusicRemote);
	return result;
}
public override bool ResetPlaylistEntries()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_ResetPlaylistEntries(m_pSteamMusicRemote);
	return result;
}
public override bool SetPlaylistEntry(int nID,int nPosition,string pchEntryText)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetPlaylistEntry(m_pSteamMusicRemote,nID,nPosition,pchEntryText);
	return result;
}
public override bool SetCurrentPlaylistEntry(int nID)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_SetCurrentPlaylistEntry(m_pSteamMusicRemote,nID);
	return result;
}
public override bool PlaylistDidChange()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamMusicRemote_PlaylistDidChange(m_pSteamMusicRemote);
	return result;
}
}
...
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamHTTP_CreateHTTPRequest(m_pSteamHTTP,eHTTPRequestMethod,pchAbsoluteURL);
	return result;
}
public override bool SetHTTPRequestContextValue(uint hRequest,ulong ulContextValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestContextValue(m_pSteamHTTP,hRequest,ulContextValue);
	return result;
}
public override bool SetHTTPRequestNetworkActivityTimeout(uint hRequest,uint unTimeoutSeconds)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestNetworkActivityTimeout(m_pSteamHTTP,hRequest,unTimeoutSeconds);
	return result;
}
public override bool SetHTTPRequestHeaderValue(uint hRequest,string pchHeaderName,string pchHeaderValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue(m_pSteamHTTP,hRequest,pchHeaderName,pchHeaderValue);
	return result;
}
public override bool SetHTTPRequestGetOrPostParameter(uint hRequest,string pchParamName,string pchParamValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter(m_pSteamHTTP,hRequest,pchParamName,pchParamValue);
	return result;
}
public override bool SendHTTPRequest(uint hRequest,ref ulong pCallHandle)
{
	CheckIfUsable();
	pCallHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SendHTTPRequest(m_pSteamHTTP,hRequest,ref pCallHandle);
	return result;
}
public override bool SendHTTPRequestAndStreamResponse(uint hRequest,ref ulong pCallHandle)
{
	CheckIfUsable();
	pCallHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SendHTTPRequestAndStreamResponse(m_pSteamHTTP,hRequest,ref pCallHandle);
	return result;
}
public override bool DeferHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_DeferHTTPRequest(m_pSteamHTTP,hRequest);
	return result;
}
public override bool PrioritizeHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_PrioritizeHTTPRequest(m_pSteamHTTP,hRequest);
	return result;
}
public override bool GetHTTPResponseHeaderSize(uint hRequest,string pchHeaderName,ref uint unResponseHeaderSize)
{
	...
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize(m_pSteamHTTP,hRequest,pchHeaderName,ref unResponseHeaderSize);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue(m_pSteamHTTP,hRequest,pchHeaderName,pHeaderValueBuffer,unBufferSize);
	return result;
}
public override bool GetHTTPResponseBodySize(uint hRequest,ref uint unBodySize)
{
	CheckIfUsable();
	unBodySize = 0;
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPResponseBodySize(m_pSteamHTTP,hRequest,ref unBodySize);
	return result;
}
public override bool GetHTTPResponseBodyData(uint hRequest,IntPtr pBodyDataBuffer,uint unBufferSize)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPResponseBodyData(m_pSteamHTTP,hRequest,pBodyDataBuffer,unBufferSize);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPStreamingResponseBodyData(m_pSteamHTTP,hRequest,cOffset,pBodyDataBuffer,unBufferSize);
	return result;
}
public override bool ReleaseHTTPRequest(uint hRequest)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_ReleaseHTTPRequest(m_pSteamHTTP,hRequest);
	return result;
}
public override bool GetHTTPDownloadProgressPct(uint hRequest,ref float pflPercentOut)
{
	CheckIfUsable();
	pflPercentOut = 0;
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPDownloadProgressPct(m_pSteamHTTP,hRequest,ref pflPercentOut);
	return result;
}
public override bool SetHTTPRequestRawPostBody(uint hRequest,string pchContentType,IntPtr pubBody,uint unBodyLen)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody(m_pSteamHTTP,hRequest,pchContentType,pubBody,unBodyLen);
	return result;
}
public override uint CreateCookieContainer(bool bAllowResponsesToModify)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamHTTP_CreateCookieContainer(m_pSteamHTTP,bAllowResponsesToModify);
	return result;
}
public override bool ReleaseCookieContainer(uint hCookieContainer)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_ReleaseCookieContainer(m_pSteamHTTP,hCookieContainer);
	return result;
}
public override bool SetCookie(uint hCookieContainer,string pchHost,string pchUrl,string pchCookie)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetCookie(m_pSteamHTTP,hCookieContainer,pchHost,pchUrl,pchCookie);
	return result;
}
public override bool SetHTTPRequestCookieContainer(uint hRequest,uint hCookieContainer)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestCookieContainer(m_pSteamHTTP,hRequest,hCookieContainer);
	return result;
}
public override bool SetHTTPRequestUserAgentInfo(uint hRequest,string pchUserAgentInfo)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo(m_pSteamHTTP,hRequest,pchUserAgentInfo);
	return result;
}
public override bool SetHTTPRequestRequiresVerifiedCertificate(uint hRequest,bool bRequireVerifiedCertificate)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestRequiresVerifiedCertificate(m_pSteamHTTP,hRequest,bRequireVerifiedCertificate);
	return result;
}
public override bool SetHTTPRequestAbsoluteTimeoutMS(uint hRequest,uint unMilliseconds)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTTP_SetHTTPRequestAbsoluteTimeoutMS(m_pSteamHTTP,hRequest,unMilliseconds);
	return result;
}
public override bool GetHTTPRequestWasTimedOut(uint hRequest,ref bool pbWasTimedOut)
{
	CheckIfUsable();
	pbWasTimedOut = false;
	bool result = NativeCalls.SteamAPI_ISteamHTTP_GetHTTPRequestWasTimedOut(m_pSteamHTTP,hRequest,ref pbWasTimedOut);
	return result;
}
}
...
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUnifiedMessages_SendMethod(m_pSteamUnifiedMessages,pchServiceMethod,pRequestBuffer,unRequestBufferSize,unContext);
	return result;
}
public override bool GetMethodResponseInfo(ulong hHandle,ref uint punResponseSize,ref uint peResult)
{
	...
	punResponseSize = 0;
	peResult = 0;
	bool result = NativeCalls.SteamAPI_ISteamUnifiedMessages_GetMethodResponseInfo(m_pSteamUnifiedMessages,hHandle,ref punResponseSize,ref peResult);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUnifiedMessages_GetMethodResponseData(m_pSteamUnifiedMessages,hHandle,pResponseBuffer,unResponseBufferSize,bAutoRelease);
	return result;
}
public override bool ReleaseMethod(ulong hHandle)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUnifiedMessages_ReleaseMethod(m_pSteamUnifiedMessages,hHandle);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUnifiedMessages_SendNotification(m_pSteamUnifiedMessages,pchServiceNotification,pNotificationBuffer,unNotificationBufferSize);
	return result;
}
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamController_Init(m_pSteamController);
	return result;
}
public override bool Shutdown()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamController_Shutdown(m_pSteamController);
	return result;
}
public override void RunFrame()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamController_RunFrame(m_pSteamController);
}
public override int GetConnectedControllers(ulong[] handlesOut)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamController_GetConnectedControllers(m_pSteamController, handlesOut);
	return result;
}
public override bool ShowBindingPanel(ulong controllerHandle)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamController_ShowBindingPanel(m_pSteamController,controllerHandle);
	return result;
}
public override ulong GetActionSetHandle(string pszActionSetName)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamController_GetActionSetHandle(m_pSteamController,pszActionSetName);
	return result;
}
public override void ActivateActionSet(ulong controllerHandle,ulong actionSetHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamController_ActivateActionSet(m_pSteamController,controllerHandle,actionSetHandle);
}
public override ulong GetCurrentActionSet(ulong controllerHandle)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamController_GetCurrentActionSet(m_pSteamController,controllerHandle);
	return result;
}
public override ulong GetDigitalActionHandle(string pszActionName)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamController_GetDigitalActionHandle(m_pSteamController,pszActionName);
	return result;
}
public override ControllerDigitalActionData_t GetDigitalActionData(ulong controllerHandle,ulong digitalActionHandle)
{
	CheckIfUsable();
	return NativeCalls.SteamAPI_ISteamController_GetDigitalActionData(m_pSteamController, controllerHandle, digitalActionHandle);
}
public override int GetDigitalActionOrigins(ulong controllerHandle,ulong actionSetHandle,ulong digitalActionHandle, EControllerActionOrigin[] originsOut)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamController_GetDigitalActionOrigins(m_pSteamController,controllerHandle,actionSetHandle,digitalActionHandle, originsOut);
	return result;
}
public override ulong GetAnalogActionHandle(string pszActionName)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamController_GetAnalogActionHandle(m_pSteamController,pszActionName);
	return result;
}
public override ControllerAnalogActionData_t GetAnalogActionData(ulong controllerHandle, ulong analogActionHandle)
{
	CheckIfUsable();
	return NativeCalls.SteamAPI_ISteamController_GetAnalogActionData(m_pSteamController,controllerHandle,analogActionHandle);
}
public override int GetAnalogActionOrigins(ulong controllerHandle,ulong actionSetHandle,ulong analogActionHandle, EControllerActionOrigin[] originsOut)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamController_GetAnalogActionOrigins(m_pSteamController,controllerHandle,actionSetHandle,analogActionHandle, originsOut);
	return result;
}
public override void StopAnalogActionMomentum(ulong controllerHandle,ulong eAction)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamController_StopAnalogActionMomentum(m_pSteamController,controllerHandle,eAction);
}
public override void TriggerHapticPulse(ulong controllerHandle, ESteamControllerPad eTargetPad, ushort usDurationMicroSec)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamController_TriggerHapticPulse(m_pSteamController, controllerHandle, eTargetPad, usDurationMicroSec);
}
}
...
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_CreateQueryUserUGCRequest(m_pSteamUGC,unAccountID,eListType,eMatchingUGCType,eSortOrder,nCreatorAppID,nConsumerAppID,unPage);
	return result;
}
...
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_CreateQueryAllUGCRequest(m_pSteamUGC,eQueryType,eMatchingeMatchingUGCTypeFileType,nCreatorAppID,nConsumerAppID,unPage);
	return result;
}
public override ulong CreateQueryUGCDetailsRequest(ref ulong pvecPublishedFileID,uint unNumPublishedFileIDs)
{
	...
	ulong result = NativeCalls.SteamAPI_ISteamUGC_CreateQueryUGCDetailsRequest(m_pSteamUGC,ref pvecPublishedFileID,unNumPublishedFileIDs);
	return result;
}
public override ulong SendQueryUGCRequest(ulong handle)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_SendQueryUGCRequest(m_pSteamUGC,handle);
	return result;
}
public override bool GetQueryUGCResult(ulong handle,uint index,ref SteamUGCDetails_t pDetails)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCResult(m_pSteamUGC,handle,index,ref pDetails);
	return result;
}
public override bool GetQueryUGCPreviewURL(ulong handle,uint index,string pchURL,uint cchURLSize)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCPreviewURL(m_pSteamUGC,handle,index,pchURL,cchURLSize);
	return result;
}
public override bool GetQueryUGCMetadata(ulong handle,uint index,string pchMetadata,uint cchMetadatasize)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCMetadata(m_pSteamUGC,handle,index,pchMetadata,cchMetadatasize);
	return result;
}
public override bool GetQueryUGCChildren(ulong handle,uint index,ref ulong pvecPublishedFileID,uint cMaxEntries)
{
	CheckIfUsable();
	pvecPublishedFileID = 0;
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCChildren(m_pSteamUGC,handle,index,ref pvecPublishedFileID,cMaxEntries);
	return result;
}
public override bool GetQueryUGCStatistic(ulong handle,uint index,uint eStatType,ref uint pStatValue)
{
	CheckIfUsable();
	pStatValue = 0;
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCStatistic(m_pSteamUGC,handle,index,eStatType,ref pStatValue);
	return result;
}
public override uint GetQueryUGCNumAdditionalPreviews(ulong handle,uint index)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCNumAdditionalPreviews(m_pSteamUGC,handle,index);
	return result;
}
public override bool GetQueryUGCAdditionalPreview(ulong handle,uint index,uint previewIndex,string pchURLOrVideoID,uint cchURLSize,ref bool pbIsImage)
{
	CheckIfUsable();
	pbIsImage = false;
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCAdditionalPreview(m_pSteamUGC,handle,index,previewIndex,pchURLOrVideoID,cchURLSize,ref pbIsImage);
	return result;
}
public override uint GetQueryUGCNumKeyValueTags(ulong handle,uint index)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCNumKeyValueTags(m_pSteamUGC,handle,index);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetQueryUGCKeyValueTag(m_pSteamUGC,handle,index,keyValueTagIndex,pchKey,cchKeySize,pchValue,cchValueSize);
	return result;
}
public override bool ReleaseQueryUGCRequest(ulong handle)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_ReleaseQueryUGCRequest(m_pSteamUGC,handle);
	return result;
}
public override bool AddRequiredTag(ulong handle,string pTagName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_AddRequiredTag(m_pSteamUGC,handle,pTagName);
	return result;
}
public override bool AddExcludedTag(ulong handle,string pTagName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_AddExcludedTag(m_pSteamUGC,handle,pTagName);
	return result;
}
public override bool SetReturnKeyValueTags(ulong handle,bool bReturnKeyValueTags)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnKeyValueTags(m_pSteamUGC,handle,bReturnKeyValueTags);
	return result;
}
public override bool SetReturnLongDescription(ulong handle,bool bReturnLongDescription)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnLongDescription(m_pSteamUGC,handle,bReturnLongDescription);
	return result;
}
public override bool SetReturnMetadata(ulong handle,bool bReturnMetadata)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnMetadata(m_pSteamUGC,handle,bReturnMetadata);
	return result;
}
public override bool SetReturnChildren(ulong handle,bool bReturnChildren)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnChildren(m_pSteamUGC,handle,bReturnChildren);
	return result;
}
public override bool SetReturnAdditionalPreviews(ulong handle,bool bReturnAdditionalPreviews)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnAdditionalPreviews(m_pSteamUGC,handle,bReturnAdditionalPreviews);
	return result;
}
public override bool SetReturnTotalOnly(ulong handle,bool bReturnTotalOnly)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetReturnTotalOnly(m_pSteamUGC,handle,bReturnTotalOnly);
	return result;
}
public override bool SetLanguage(ulong handle,string pchLanguage)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetLanguage(m_pSteamUGC,handle,pchLanguage);
	return result;
}
public override bool SetAllowCachedResponse(ulong handle,uint unMaxAgeSeconds)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetAllowCachedResponse(m_pSteamUGC,handle,unMaxAgeSeconds);
	return result;
}
public override bool SetCloudFileNameFilter(ulong handle,string pMatchCloudFileName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetCloudFileNameFilter(m_pSteamUGC,handle,pMatchCloudFileName);
	return result;
}
public override bool SetMatchAnyTag(ulong handle,bool bMatchAnyTag)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetMatchAnyTag(m_pSteamUGC,handle,bMatchAnyTag);
	return result;
}
public override bool SetSearchText(ulong handle,string pSearchText)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetSearchText(m_pSteamUGC,handle,pSearchText);
	return result;
}
public override bool SetRankedByTrendDays(ulong handle,uint unDays)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetRankedByTrendDays(m_pSteamUGC,handle,unDays);
	return result;
}
public override bool AddRequiredKeyValueTag(ulong handle,string pKey,string pValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_AddRequiredKeyValueTag(m_pSteamUGC,handle,pKey,pValue);
	return result;
}
public override ulong RequestUGCDetails(ulong nPublishedFileID,uint unMaxAgeSeconds)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_RequestUGCDetails(m_pSteamUGC,nPublishedFileID,unMaxAgeSeconds);
	return result;
}
public override ulong CreateItem(uint nConsumerAppId,uint eFileType)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_CreateItem(m_pSteamUGC,nConsumerAppId,eFileType);
	return result;
}
public override ulong StartItemUpdate(uint nConsumerAppId,ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_StartItemUpdate(m_pSteamUGC,nConsumerAppId,nPublishedFileID);
	return result;
}
public override bool SetItemTitle(ulong handle,string pchTitle)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemTitle(m_pSteamUGC,handle,pchTitle);
	return result;
}
public override bool SetItemDescription(ulong handle,string pchDescription)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemDescription(m_pSteamUGC,handle,pchDescription);
	return result;
}
public override bool SetItemUpdateLanguage(ulong handle,string pchLanguage)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemUpdateLanguage(m_pSteamUGC,handle,pchLanguage);
	return result;
}
public override bool SetItemMetadata(ulong handle,string pchMetaData)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemMetadata(m_pSteamUGC,handle,pchMetaData);
	return result;
}
public override bool SetItemVisibility(ulong handle,uint eVisibility)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemVisibility(m_pSteamUGC,handle,eVisibility);
	return result;
}
public override bool SetItemTags(ulong updateHandle,ref SteamParamStringArray_t pTags)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemTags(m_pSteamUGC,updateHandle,ref pTags);
	return result;
}
public override bool SetItemContent(ulong handle,string pszContentFolder)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemContent(m_pSteamUGC,handle,pszContentFolder);
	return result;
}
public override bool SetItemPreview(ulong handle,string pszPreviewFile)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_SetItemPreview(m_pSteamUGC,handle,pszPreviewFile);
	return result;
}
public override bool RemoveItemKeyValueTags(ulong handle,string pchKey)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_RemoveItemKeyValueTags(m_pSteamUGC,handle,pchKey);
	return result;
}
public override bool AddItemKeyValueTag(ulong handle,string pchKey,string pchValue)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_AddItemKeyValueTag(m_pSteamUGC,handle,pchKey,pchValue);
	return result;
}
public override ulong SubmitItemUpdate(ulong handle,string pchChangeNote)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_SubmitItemUpdate(m_pSteamUGC,handle,pchChangeNote);
	return result;
}
public override uint GetItemUpdateProgress(ulong handle,ref ulong punBytesProcessed,ref ulong punBytesTotal)
{
	...
	punBytesProcessed = 0;
	punBytesTotal = 0;
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetItemUpdateProgress(m_pSteamUGC,handle,ref punBytesProcessed,ref punBytesTotal);
	return result;
}
public override ulong SetUserItemVote(ulong nPublishedFileID,bool bVoteUp)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_SetUserItemVote(m_pSteamUGC,nPublishedFileID,bVoteUp);
	return result;
}
public override ulong GetUserItemVote(ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_GetUserItemVote(m_pSteamUGC,nPublishedFileID);
	return result;
}
public override ulong AddItemToFavorites(uint nAppId,ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_AddItemToFavorites(m_pSteamUGC,nAppId,nPublishedFileID);
	return result;
}
public override ulong RemoveItemFromFavorites(uint nAppId,ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_RemoveItemFromFavorites(m_pSteamUGC,nAppId,nPublishedFileID);
	return result;
}
public override ulong SubscribeItem(ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_SubscribeItem(m_pSteamUGC,nPublishedFileID);
	return result;
}
public override ulong UnsubscribeItem(ulong nPublishedFileID)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamUGC_UnsubscribeItem(m_pSteamUGC,nPublishedFileID);
	return result;
}
public override uint GetNumSubscribedItems()
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetNumSubscribedItems(m_pSteamUGC);
	return result;
}
public override uint GetSubscribedItems(ref ulong pvecPublishedFileID,uint cMaxEntries)
{
	CheckIfUsable();
	pvecPublishedFileID = 0;
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetSubscribedItems(m_pSteamUGC,ref pvecPublishedFileID,cMaxEntries);
	return result;
}
public override uint GetItemState(ulong nPublishedFileID)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamUGC_GetItemState(m_pSteamUGC,nPublishedFileID);
	return result;
}
public override bool GetItemInstallInfo(ulong nPublishedFileID,ref ulong punSizeOnDisk,string pchFolder,uint cchFolderSize,ref uint punTimeStamp)
{
	...
	punSizeOnDisk = 0;
	punTimeStamp = 0;
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetItemInstallInfo(m_pSteamUGC,nPublishedFileID,ref punSizeOnDisk,pchFolder,cchFolderSize,ref punTimeStamp);
	return result;
}
public override bool GetItemDownloadInfo(ulong nPublishedFileID,ref ulong punBytesDownloaded,ref ulong punBytesTotal)
{
	...
	punBytesDownloaded = 0;
	punBytesTotal = 0;
	bool result = NativeCalls.SteamAPI_ISteamUGC_GetItemDownloadInfo(m_pSteamUGC,nPublishedFileID,ref punBytesDownloaded,ref punBytesTotal);
	return result;
}
public override bool DownloadItem(ulong nPublishedFileID,bool bHighPriority)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_DownloadItem(m_pSteamUGC,nPublishedFileID,bHighPriority);
	return result;
}
public override bool BInitWorkshopForGameServer(uint unWorkshopDepotID,string pszFolder)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamUGC_BInitWorkshopForGameServer(m_pSteamUGC,unWorkshopDepotID,pszFolder);
	return result;
}
public override void SuspendDownloads(bool bSuspend)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamUGC_SuspendDownloads(m_pSteamUGC,bSuspend);
}
}
...
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamAppList_GetNumInstalledApps(m_pSteamAppList);
	return result;
}
public override uint GetInstalledApps(ref uint pvecAppID,uint unMaxAppIDs)
{
	CheckIfUsable();
	pvecAppID = 0;
	uint result = NativeCalls.SteamAPI_ISteamAppList_GetInstalledApps(m_pSteamAppList,ref pvecAppID,unMaxAppIDs);
	return result;
}
public override int GetAppName(uint nAppID,string pchName,int cchNameMax)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamAppList_GetAppName(m_pSteamAppList,nAppID,pchName,cchNameMax);
	return result;
}
public override int GetAppInstallDir(uint nAppID,string pchDirectory,int cchNameMax)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamAppList_GetAppInstallDir(m_pSteamAppList,nAppID,pchDirectory,cchNameMax);
	return result;
}
public override int GetAppBuildId(uint nAppID)
{
	CheckIfUsable();
	int result = NativeCalls.SteamAPI_ISteamAppList_GetAppBuildId(m_pSteamAppList,nAppID);
	return result;
}
}
...
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_DestructISteamHTMLSurface(m_pSteamHTMLSurface);
}
public override bool Init()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTMLSurface_Init(m_pSteamHTMLSurface);
	return result;
}
public override bool Shutdown()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamHTMLSurface_Shutdown(m_pSteamHTMLSurface);
	return result;
}
public override ulong CreateBrowser(string pchUserAgent,string pchUserCSS)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamHTMLSurface_CreateBrowser(m_pSteamHTMLSurface,pchUserAgent,pchUserCSS);
	return result;
}
public override void RemoveBrowser(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_RemoveBrowser(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void LoadURL(uint unBrowserHandle,string pchURL,string pchPostData)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_LoadURL(m_pSteamHTMLSurface,unBrowserHandle,pchURL,pchPostData);
}
public override void SetSize(uint unBrowserHandle,uint unWidth,uint unHeight)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetSize(m_pSteamHTMLSurface,unBrowserHandle,unWidth,unHeight);
}
public override void StopLoad(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_StopLoad(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void Reload(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_Reload(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void GoBack(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_GoBack(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void GoForward(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_GoForward(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void AddHeader(uint unBrowserHandle,string pchKey,string pchValue)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_AddHeader(m_pSteamHTMLSurface,unBrowserHandle,pchKey,pchValue);
}
public override void ExecuteJavascript(uint unBrowserHandle,string pchScript)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_ExecuteJavascript(m_pSteamHTMLSurface,unBrowserHandle,pchScript);
}
public override void MouseUp(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_MouseUp(m_pSteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseDown(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_MouseDown(m_pSteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseDoubleClick(uint unBrowserHandle,uint eMouseButton)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_MouseDoubleClick(m_pSteamHTMLSurface,unBrowserHandle,eMouseButton);
}
public override void MouseMove(uint unBrowserHandle,int x,int y)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_MouseMove(m_pSteamHTMLSurface,unBrowserHandle,x,y);
}
public override void MouseWheel(uint unBrowserHandle,int nDelta)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_MouseWheel(m_pSteamHTMLSurface,unBrowserHandle,nDelta);
}
public override void KeyDown(uint unBrowserHandle,uint nNativeKeyCode,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_KeyDown(m_pSteamHTMLSurface,unBrowserHandle,nNativeKeyCode,eHTMLKeyModifiers);
}
public override void KeyUp(uint unBrowserHandle,uint nNativeKeyCode,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_KeyUp(m_pSteamHTMLSurface,unBrowserHandle,nNativeKeyCode,eHTMLKeyModifiers);
}
public override void KeyChar(uint unBrowserHandle,uint cUnicodeChar,uint eHTMLKeyModifiers)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_KeyChar(m_pSteamHTMLSurface,unBrowserHandle,cUnicodeChar,eHTMLKeyModifiers);
}
public override void SetHorizontalScroll(uint unBrowserHandle,uint nAbsolutePixelScroll)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetHorizontalScroll(m_pSteamHTMLSurface,unBrowserHandle,nAbsolutePixelScroll);
}
public override void SetVerticalScroll(uint unBrowserHandle,uint nAbsolutePixelScroll)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetVerticalScroll(m_pSteamHTMLSurface,unBrowserHandle,nAbsolutePixelScroll);
}
public override void SetKeyFocus(uint unBrowserHandle,bool bHasKeyFocus)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetKeyFocus(m_pSteamHTMLSurface,unBrowserHandle,bHasKeyFocus);
}
public override void ViewSource(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_ViewSource(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void CopyToClipboard(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_CopyToClipboard(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void PasteFromClipboard(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_PasteFromClipboard(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void Find(uint unBrowserHandle,string pchSearchStr,bool bCurrentlyInFind,bool bReverse)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_Find(m_pSteamHTMLSurface,unBrowserHandle,pchSearchStr,bCurrentlyInFind,bReverse);
}
public override void StopFind(uint unBrowserHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_StopFind(m_pSteamHTMLSurface,unBrowserHandle);
}
public override void GetLinkAtPosition(uint unBrowserHandle,int x,int y)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_GetLinkAtPosition(m_pSteamHTMLSurface,unBrowserHandle,x,y);
}
...
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetCookie(m_pSteamHTMLSurface,pchHostname,pchKey,pchValue,pchPath,nExpires,bSecure,bHTTPOnly);
}
public override void SetPageScaleFactor(uint unBrowserHandle,float flZoom,int nPointX,int nPointY)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetPageScaleFactor(m_pSteamHTMLSurface,unBrowserHandle,flZoom,nPointX,nPointY);
}
public override void SetBackgroundMode(uint unBrowserHandle,bool bBackgroundMode)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_SetBackgroundMode(m_pSteamHTMLSurface,unBrowserHandle,bBackgroundMode);
}
public override void AllowStartRequest(uint unBrowserHandle,bool bAllowed)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_AllowStartRequest(m_pSteamHTMLSurface,unBrowserHandle,bAllowed);
}
public override void JSDialogResponse(uint unBrowserHandle,bool bResult)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamHTMLSurface_JSDialogResponse(m_pSteamHTMLSurface,unBrowserHandle,bResult);
}
public override void FileLoadDialogResponse(uint unBrowserHandle,string pchSelectedFiles)
{
	CheckIfUsable();
	pchSelectedFiles = "";
	NativeCalls.SteamAPI_ISteamHTMLSurface_FileLoadDialogResponse(m_pSteamHTMLSurface,unBrowserHandle,pchSelectedFiles);
}
}
...
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamInventory_GetResultStatus(m_pSteamInventory,resultHandle);
	return result;
}
public override bool GetResultItems(int resultHandle,out SteamItemDetails_t [] pOutItemsArray)
{
	...
	bool result = NativeCalls.SteamAPI_ISteamInventory_GetResultItems(m_pSteamInventory,resultHandle,null,ref punOutItemsArraySize);
	pOutItemsArray= new SteamItemDetails_t[punOutItemsArraySize];
	 result = NativeCalls.SteamAPI_ISteamInventory_GetResultItems(m_pSteamInventory,resultHandle,pOutItemsArray,ref punOutItemsArraySize);
	return result;
}
public override uint GetResultTimestamp(int resultHandle)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamInventory_GetResultTimestamp(m_pSteamInventory,resultHandle);
	return result;
}
public override bool CheckResultSteamID(int resultHandle,ulong steamIDExpected)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamInventory_CheckResultSteamID(m_pSteamInventory,resultHandle,steamIDExpected);
	return result;
}
public override void DestroyResult(int resultHandle)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamInventory_DestroyResult(m_pSteamInventory,resultHandle);
}
public override bool GetAllItems(ref int pResultHandle)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_GetAllItems(m_pSteamInventory,ref pResultHandle);
	return result;
}
public override bool GetItemsByID(ref int pResultHandle,ulong [] pInstanceIDs)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_GetItemsByID(m_pSteamInventory,ref pResultHandle,pInstanceIDs,(uint) pInstanceIDs.Length);
	return result;
}
public override bool SerializeResult(int resultHandle,IntPtr pOutBuffer,ref uint punOutBufferSize)
{
	CheckIfUsable();
	punOutBufferSize = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_SerializeResult(m_pSteamInventory,resultHandle,pOutBuffer,ref punOutBufferSize);
	return result;
}
public override bool DeserializeResult(ref int pOutResultHandle,IntPtr pBuffer,uint unBufferSize,bool bRESERVED_MUST_BE_FALSE)
{
	CheckIfUsable();
	pOutResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_DeserializeResult(m_pSteamInventory,ref pOutResultHandle,pBuffer,unBufferSize,bRESERVED_MUST_BE_FALSE);
	return result;
}
public override bool GenerateItems(ref int pResultHandle,int [] pArrayItemDefs,uint [] punArrayQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_GenerateItems(m_pSteamInventory,ref pResultHandle,pArrayItemDefs,punArrayQuantity,(uint) punArrayQuantity.Length);
	return result;
}
public override bool GrantPromoItems(ref int pResultHandle)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_GrantPromoItems(m_pSteamInventory,ref pResultHandle);
	return result;
}
public override bool AddPromoItem(ref int pResultHandle,int itemDef)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_AddPromoItem(m_pSteamInventory,ref pResultHandle,itemDef);
	return result;
}
public override bool AddPromoItems(ref int pResultHandle,int [] pArrayItemDefs)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_AddPromoItems(m_pSteamInventory,ref pResultHandle,pArrayItemDefs,(uint) pArrayItemDefs.Length);
	return result;
}
public override bool ConsumeItem(ref int pResultHandle,ulong itemConsume,uint unQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_ConsumeItem(m_pSteamInventory,ref pResultHandle,itemConsume,unQuantity);
	return result;
}
public override bool ExchangeItems(ref int pResultHandle,int [] pArrayGenerate,uint [] punArrayGenerateQuantity,ulong [] pArrayDestroy,uint [] punArrayDestroyQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_ExchangeItems(m_pSteamInventory,ref pResultHandle,pArrayGenerate,punArrayGenerateQuantity,(uint) punArrayGenerateQuantity.Length,pArrayDestroy,punArrayDestroyQuantity,(uint) punArrayDestroyQuantity.Length);
	return result;
}
public override bool TransferItemQuantity(ref int pResultHandle,ulong itemIdSource,uint unQuantity,ulong itemIdDest)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_TransferItemQuantity(m_pSteamInventory,ref pResultHandle,itemIdSource,unQuantity,itemIdDest);
	return result;
}
public override void SendItemDropHeartbeat()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamInventory_SendItemDropHeartbeat(m_pSteamInventory);
}
public override bool TriggerItemDrop(ref int pResultHandle,int dropListDefinition)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_TriggerItemDrop(m_pSteamInventory,ref pResultHandle,dropListDefinition);
	return result;
}
public override bool TradeItems(ref int pResultHandle,ulong steamIDTradePartner,ulong [] pArrayGive,uint [] pArrayGiveQuantity,ulong [] pArrayGet,uint [] pArrayGetQuantity)
{
	CheckIfUsable();
	pResultHandle = 0;
	bool result = NativeCalls.SteamAPI_ISteamInventory_TradeItems(m_pSteamInventory,ref pResultHandle,steamIDTradePartner,pArrayGive,pArrayGiveQuantity,(uint) pArrayGiveQuantity.Length,pArrayGet,pArrayGetQuantity,(uint) pArrayGetQuantity.Length);
	return result;
}
public override bool LoadItemDefinitions()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamInventory_LoadItemDefinitions(m_pSteamInventory);
	return result;
}
public override bool GetItemDefinitionIDs(out int [] pItemDefIDs)
{
	...
	bool result = NativeCalls.SteamAPI_ISteamInventory_GetItemDefinitionIDs(m_pSteamInventory,null,ref punItemDefIDsArraySize);
	pItemDefIDs= new int[punItemDefIDsArraySize];
	 result = NativeCalls.SteamAPI_ISteamInventory_GetItemDefinitionIDs(m_pSteamInventory,pItemDefIDs,ref punItemDefIDsArraySize);
	return result;
}
public override bool GetItemDefinitionProperty(int iDefinition,string pchPropertyName,out string pchValueBuffer)
{
	...
	bool result = NativeCalls.SteamAPI_ISteamInventory_GetItemDefinitionProperty(m_pSteamInventory,iDefinition,pchPropertyName,null,ref punValueBufferSize);
	System.Text.StringBuilder pStrBuffer = new System.Text.StringBuilder((int)punValueBufferSize);
	 result = NativeCalls.SteamAPI_ISteamInventory_GetItemDefinitionProperty(m_pSteamInventory,iDefinition,pchPropertyName,pStrBuffer,ref punValueBufferSize);
...
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamVideo_GetVideoURL(m_pSteamVideo,unVideoAppID);
}
public override bool IsBroadcasting(ref int pnNumViewers)
{
	CheckIfUsable();
	pnNumViewers = 0;
	bool result = NativeCalls.SteamAPI_ISteamVideo_IsBroadcasting(m_pSteamVideo,ref pnNumViewers);
	return result;
}
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_InitGameServer(m_pSteamGameServer,unIP,usGamePort,usQueryPort,unFlags,nGameAppId,pchVersionString);
	return result;
}
public override void SetProduct(string pszProduct)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetProduct(m_pSteamGameServer,pszProduct);
}
public override void SetGameDescription(string pszGameDescription)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetGameDescription(m_pSteamGameServer,pszGameDescription);
}
public override void SetModDir(string pszModDir)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetModDir(m_pSteamGameServer,pszModDir);
}
public override void SetDedicatedServer(bool bDedicated)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetDedicatedServer(m_pSteamGameServer,bDedicated);
}
public override void LogOn(string pszToken)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_LogOn(m_pSteamGameServer,pszToken);
}
public override void LogOnAnonymous()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_LogOnAnonymous(m_pSteamGameServer);
}
public override void LogOff()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_LogOff(m_pSteamGameServer);
}
public override bool BLoggedOn()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_BLoggedOn(m_pSteamGameServer);
	return result;
}
public override bool BSecure()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_BSecure(m_pSteamGameServer);
	return result;
}
public override ulong GetSteamID()
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServer_GetSteamID(m_pSteamGameServer);
	return result;
}
public override bool WasRestartRequested()
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_WasRestartRequested(m_pSteamGameServer);
	return result;
}
public override void SetMaxPlayerCount(int cPlayersMax)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetMaxPlayerCount(m_pSteamGameServer,cPlayersMax);
}
public override void SetBotPlayerCount(int cBotplayers)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetBotPlayerCount(m_pSteamGameServer,cBotplayers);
}
public override void SetServerName(string pszServerName)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetServerName(m_pSteamGameServer,pszServerName);
}
public override void SetMapName(string pszMapName)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetMapName(m_pSteamGameServer,pszMapName);
}
public override void SetPasswordProtected(bool bPasswordProtected)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetPasswordProtected(m_pSteamGameServer,bPasswordProtected);
}
public override void SetSpectatorPort(char unSpectatorPort)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetSpectatorPort(m_pSteamGameServer,unSpectatorPort);
}
public override void SetSpectatorServerName(string pszSpectatorServerName)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetSpectatorServerName(m_pSteamGameServer,pszSpectatorServerName);
}
public override void ClearAllKeyValues()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_ClearAllKeyValues(m_pSteamGameServer);
}
public override void SetKeyValue(string pKey,string pValue)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetKeyValue(m_pSteamGameServer,pKey,pValue);
}
public override void SetGameTags(string pchGameTags)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetGameTags(m_pSteamGameServer,pchGameTags);
}
public override void SetGameData(string pchGameData)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetGameData(m_pSteamGameServer,pchGameData);
}
public override void SetRegion(string pszRegion)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetRegion(m_pSteamGameServer,pszRegion);
}
public override bool SendUserConnectAndAuthenticate(uint unIPClient,IntPtr pvAuthBlob,uint cubAuthBlobSize,ref ulong pSteamIDUser)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate(m_pSteamGameServer,unIPClient,pvAuthBlob,cubAuthBlobSize,ref pSteamIDUser);
	return result;
}
public override ulong CreateUnauthenticatedUserConnection()
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection(m_pSteamGameServer);
	return result;
}
public override void SendUserDisconnect(ulong steamIDUser)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SendUserDisconnect(m_pSteamGameServer,steamIDUser);
}
public override bool BUpdateUserData(ulong steamIDUser,string pchPlayerName,uint uScore)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_BUpdateUserData(m_pSteamGameServer,steamIDUser,pchPlayerName,uScore);
	return result;
}
public override uint GetAuthSessionTicket(IntPtr pTicket,int cbMaxTicket,ref uint pcbTicket)
{
	CheckIfUsable();
	pcbTicket = 0;
	uint result = NativeCalls.SteamAPI_ISteamGameServer_GetAuthSessionTicket(m_pSteamGameServer,pTicket,cbMaxTicket,ref pcbTicket);
	return result;
}
public override uint BeginAuthSession(IntPtr pAuthTicket,int cbAuthTicket,ulong steamID)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamGameServer_BeginAuthSession(m_pSteamGameServer,pAuthTicket,cbAuthTicket,steamID);
	return result;
}
public override void EndAuthSession(ulong steamID)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_EndAuthSession(m_pSteamGameServer,steamID);
}
public override void CancelAuthTicket(uint hAuthTicket)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_CancelAuthTicket(m_pSteamGameServer,hAuthTicket);
}
public override uint UserHasLicenseForApp(ulong steamID,uint appID)
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamGameServer_UserHasLicenseForApp(m_pSteamGameServer,steamID,appID);
	return result;
}
public override bool RequestUserGroupStatus(ulong steamIDUser,ulong steamIDGroup)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_RequestUserGroupStatus(m_pSteamGameServer,steamIDUser,steamIDGroup);
	return result;
}
public override void GetGameplayStats()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_GetGameplayStats(m_pSteamGameServer);
}
public override ulong GetServerReputation()
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServer_GetServerReputation(m_pSteamGameServer);
	return result;
}
public override uint GetPublicIP()
{
	CheckIfUsable();
	uint result = NativeCalls.SteamAPI_ISteamGameServer_GetPublicIP(m_pSteamGameServer);
	return result;
}
public override bool HandleIncomingPacket(IntPtr pData,int cbData,uint srcIP,char srcPort)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServer_HandleIncomingPacket(m_pSteamGameServer,pData,cbData,srcIP,srcPort);
	return result;
}
public override int GetNextOutgoingPacket(IntPtr pOut,int cbMaxOut,ref uint pNetAdr,ref char pPort)
{
	...
	pNetAdr = 0;
	pPort = (char) 0;
	int result = NativeCalls.SteamAPI_ISteamGameServer_GetNextOutgoingPacket(m_pSteamGameServer,pOut,cbMaxOut,ref pNetAdr,ref pPort);
	return result;
}
public override void EnableHeartbeats(bool bActive)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_EnableHeartbeats(m_pSteamGameServer,bActive);
}
public override void SetHeartbeatInterval(int iHeartbeatInterval)
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_SetHeartbeatInterval(m_pSteamGameServer,iHeartbeatInterval);
}
public override void ForceHeartbeat()
{
	CheckIfUsable();
	NativeCalls.SteamAPI_ISteamGameServer_ForceHeartbeat(m_pSteamGameServer);
}
public override ulong AssociateWithClan(ulong steamIDClan)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServer_AssociateWithClan(m_pSteamGameServer,steamIDClan);
	return result;
}
public override ulong ComputeNewPlayerCompatibility(ulong steamIDNewPlayer)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility(m_pSteamGameServer,steamIDNewPlayer);
	return result;
}
}
...
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServerStats_RequestUserStats(m_pSteamGameServerStats,steamIDUser);
	return result;
}
public override bool GetUserStat(ulong steamIDUser,string pchName,ref int pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_GetUserStat(m_pSteamGameServerStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserStat0(ulong steamIDUser,string pchName,ref float pData)
{
	CheckIfUsable();
	pData = 0;
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_GetUserStat0(m_pSteamGameServerStats,steamIDUser,pchName,ref pData);
	return result;
}
public override bool GetUserAchievement(ulong steamIDUser,string pchName,ref bool pbAchieved)
{
	CheckIfUsable();
	pbAchieved = false;
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_GetUserAchievement(m_pSteamGameServerStats,steamIDUser,pchName,ref pbAchieved);
	return result;
}
public override bool SetUserStat(ulong steamIDUser,string pchName,int nData)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_SetUserStat(m_pSteamGameServerStats,steamIDUser,pchName,nData);
	return result;
}
public override bool SetUserStat0(ulong steamIDUser,string pchName,float fData)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_SetUserStat0(m_pSteamGameServerStats,steamIDUser,pchName,fData);
	return result;
}
...
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat(m_pSteamGameServerStats,steamIDUser,pchName,flCountThisSession,dSessionLength);
	return result;
}
public override bool SetUserAchievement(ulong steamIDUser,string pchName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_SetUserAchievement(m_pSteamGameServerStats,steamIDUser,pchName);
	return result;
}
public override bool ClearUserAchievement(ulong steamIDUser,string pchName)
{
	CheckIfUsable();
	bool result = NativeCalls.SteamAPI_ISteamGameServerStats_ClearUserAchievement(m_pSteamGameServerStats,steamIDUser,pchName);
	return result;
}
public override ulong StoreUserStats(ulong steamIDUser)
{
	CheckIfUsable();
	ulong result = NativeCalls.SteamAPI_ISteamGameServerStats_StoreUserStats(m_pSteamGameServerStats,steamIDUser);
	return result;
}
}
...
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamAPI_UnregisterCallback", CallingConvention = CallingConvention.Cdecl)]
internal static extern void SteamAPI_UnregisterCallback(IntPtr pCallback);
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamAPI_RegisterCallResult", CallingConvention = CallingConvention.Cdecl)]
internal static extern void SteamAPI_RegisterCallResult(IntPtr pCallback, ulong hAPICall);
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamAPI_UnregisterCallResult", CallingConvention = CallingConvention.Cdecl)]
...
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamMatchmakingPingResponse", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamMatchmakingPingResponse();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamMatchmakingPlayersResponse", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamMatchmakingPlayersResponse();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamMatchmakingRulesResponse", CallingConvention = CallingConvention.Cdecl)]
...
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamMusic", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamMusic();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamMusicRemote", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamMusicRemote();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamHTTP", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamHTTP();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamUnifiedMessages", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamUnifiedMessages();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamController", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamController();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamUGC", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamUGC();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamAppList", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamAppList();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamHTMLSurface", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamHTMLSurface();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamInventory", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamInventory();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamVideo", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamVideo();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamGameServer", CallingConvention = CallingConvention.Cdecl)]
internal static extern IntPtr SteamGameServer();
[DllImportAttribute(VikingEngine.PlatformSettings.SteamApiDll, EntryPoint = "SteamGameServerStats", CallingConvention = CallingConvention.Cdecl)]
...
//    {
//        return other is ulong && this == (ulong)other;
//    }
...
//    public static bool operator ==(ulong x, ulong y)
//    {
...
//    public SteamID_t(ulong value)
//    {
//        m_comp = (SteamIDComponent_t)value;
//        m_unAll64Bits = value;
//    }

//    public override bool Equals(object other)
//    {
//        return other is SteamID_t && this == (SteamID_t)other;
//    }

//    public override int GetHashCode()
//    {
//        return m_comp.GetHashCode() + m_unAll64Bits.GetHashCode();
//    }

//    public static bool operator ==(SteamID_t x, SteamID_t y)
//    {
//        return x.m_comp == y.m_comp && x.m_unAll64Bits == y.m_unAll64Bits;
//    }
//}
...
//    public override bool Equals(object other)
//    {
//        return other is SteamIDComponent_t && this == (SteamIDComponent_t)other;
//    }

//    public override int GetHashCode()
//    {
//        return m_unAccountID.GetHashCode() + m_unAccountInstance.GetHashCode() +
//               m_EAccountType.GetHashCode() + m_EUniverse.GetHashCode();
//    }

//    public static bool operator ==(SteamIDComponent_t x, SteamIDComponent_t y)
//    {
//        return x.m_unAccountID == y.m_unAccountID &&
//               x.m_unAccountInstance == y.m_unAccountInstance &&
//               x.m_EAccountType == y.m_EAccountType &&
//               x.m_EUniverse == y.m_EUniverse;
//    }

//    public override bool Equals(object obj)
//    {
//        if (obj is SteamIDComponent_t)
//        {
//            SteamIDComponent_t o = (SteamIDComponent_t)obj;
//            return o.m_EAccountType == m_EAccountType &&
//                o.m_EUniverse == m_EUniverse &&
//                o.m_unAccountID == m_unAccountID &&
//                o.m_unAccountInstance == m_unAccountInstance;
//        }
//        return false;
//    }
//}
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamFriendsCallbacks + 31)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamFriendsCallbacks + 33)]
...
[StructLayout(LayoutKind.Sequential)] public struct FriendsEnumerateFollowingList_t
{
	...
	public ulong[] m_rgSteamID; //ulong[50]
...
/* Matchmaking */
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 2)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 3)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 4)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 5)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 6)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 7)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 9)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 10)]
public struct LobbyMatchList_t
{
	public uint m_nLobbiesMatching;
}
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 12)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 13)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 15)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamMatchmakingCallbacks + 16)]
...
[StructLayout(LayoutKind.Explicit, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 1)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 2)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 3)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 4)]
...
//[StructLayout(LayoutKind.Sequential)]
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 5)]
public struct LeaderboardScoresDownloaded_t
{
    ...
    //[StructLayout(LayoutKind.Sequential)]
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 6)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 7)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamAppsCallbacks + 5)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamNetworkingCallbacks + 2)]
public struct P2PSessionRequest_t
{
	public ulong m_steamIDRemote;
}
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamNetworkingCallbacks + 3)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamNetworkingCallbacks + 1)]
...
[StructLayout(LayoutKind.Sequential, Pack = SteamAPI.PackSize)]
[CallbackIdentity(SteamAPI.k_iSteamUserStatsCallbacks + 8)]
...
static CSteamMatchmaking matchmaking = null;

public static ISteamMatchmaking SteamMatchmaking()
{
    if (matchmaking == null)
    {
        matchmaking = new CSteamMatchmaking(SteamAPIInterop.SteamMatchmaking());
    }
    return matchmaking;
}
