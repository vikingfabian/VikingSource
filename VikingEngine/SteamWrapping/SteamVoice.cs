...
//            EVoiceResult result = SteamUser.DecompressVoice(voiceData, receivedVoiceDataSize, decompressedBuffer, DECOMPRESSED_BUFFER_SIZE, out uncWritten, SAMPLE_RATE);
...
//                    SteamFriends.SetInGameVoiceSpeaking(player.pData.netId(), false);
...
//                EVoiceResult result = SteamUser.GetVoice(true, compressedMicInputBuffer, COMPRESSED_INPUT_BUFFER_SIZE, out receivedCompressedVoiceDataSize, false, null, 0, out receivedUncompresseVoiceDataSize, SAMPLE_RATE);
